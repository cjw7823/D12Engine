...
//				{
//					candidates.push_back(SelectedSceneObject{ ri, instanceIndex, boundT });
//				}
//			}
//		}
//	}
...
//		//text += AnsiToWString(selectedRenderItem.renderItem->Instances[selectedRenderItem.instanceIndex].->Name);
//		//Logger::Info(text);
//	}
//}
