...
;
; shader debug name: 3ff7186de4181d50a940ee350878ce97.pdb
; shader hash: 3ff7186de4181d50a940ee350878ce97
;
...
; ViewId state:
;
; Number of inputs: 10, outputs: 10, patchconst: 24
...
define void @"\01?ConstantHS@@YA?AUPatchTess@@V?$InputPatch@UVertexIn@@$03@@I@Z"() {
  %cbPass_cbuffer = call %dx.types.Handle @dx.op.createHandle(i32 57, i8 2, i32 1, i32 2, i1 false), !dbg !220 ; line:118 col:46  ; CreateHandle(resourceClass,rangeId,index,nonUniformIndex)
  %cbPerObject_cbuffer = call %dx.types.Handle @dx.op.createHandle(i32 57, i8 2, i32 0, i32 0, i1 false), !dbg !220 ; line:118 col:46  ; CreateHandle(resourceClass,rangeId,index,nonUniformIndex)
  %1 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 0, i32 0), !dbg !221 ; line:122 col:40  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  %2 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 1, i32 0), !dbg !221 ; line:122 col:40  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  %3 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 2, i32 0), !dbg !221 ; line:122 col:40  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  %4 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 0, i32 1), !dbg !222 ; line:122 col:56  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  %5 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 1, i32 1), !dbg !222 ; line:122 col:56  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  %6 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 2, i32 1), !dbg !222 ; line:122 col:56  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  %.i0 = fadd fast float %1, %4, !dbg !223 ; line:122 col:45
  %.i1 = fadd fast float %2, %5, !dbg !223 ; line:122 col:45
  %.i2 = fadd fast float %3, %6, !dbg !223 ; line:122 col:45
  %7 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 0, i32 2), !dbg !224 ; line:122 col:72  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  %8 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 1, i32 2), !dbg !224 ; line:122 col:72  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  %9 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 2, i32 2), !dbg !224 ; line:122 col:72  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  %.i012 = fadd fast float %.i0, %7, !dbg !225 ; line:122 col:61
  %.i113 = fadd fast float %.i1, %8, !dbg !225 ; line:122 col:61
  %.i214 = fadd fast float %.i2, %9, !dbg !225 ; line:122 col:61
  %10 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 0, i32 3), !dbg !226 ; line:122 col:88  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  %11 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 1, i32 3), !dbg !226 ; line:122 col:88  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  %12 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 2, i32 3), !dbg !226 ; line:122 col:88  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  %.i015 = fadd fast float %.i012, %10, !dbg !227 ; line:122 col:77
  %.i116 = fadd fast float %.i113, %11, !dbg !227 ; line:122 col:77
  %.i217 = fadd fast float %.i214, %12, !dbg !227 ; line:122 col:77
  %.i019 = fmul fast float 2.500000e-01, %.i015, !dbg !228 ; line:122 col:28
  %.i121 = fmul fast float 2.500000e-01, %.i116, !dbg !228 ; line:122 col:28
  %.i223 = fmul fast float 2.500000e-01, %.i217, !dbg !228 ; line:122 col:28
  %13 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !229 ; line:122 col:12
  call void @llvm.dbg.value(metadata float %.i019, i64 0, metadata !230, metadata !231), !dbg !229 ; var:"centerL" !DIExpression(DW_OP_bit_piece, 0, 32) func:"ConstantHS"
  call void @llvm.dbg.value(metadata float %.i121, i64 0, metadata !230, metadata !232), !dbg !229 ; var:"centerL" !DIExpression(DW_OP_bit_piece, 32, 32) func:"ConstantHS"
  call void @llvm.dbg.value(metadata float %.i223, i64 0, metadata !230, metadata !233), !dbg !229 ; var:"centerL" !DIExpression(DW_OP_bit_piece, 64, 32) func:"ConstantHS"
  %14 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPerObject_cbuffer, i32 0), !dbg !234 ; line:123 col:49  ; CBufferLoadLegacy(handle,regIndex)
  %15 = extractvalue %dx.types.CBufRet.f32 %14, 0, !dbg !234 ; line:123 col:49
  %16 = extractvalue %dx.types.CBufRet.f32 %14, 1, !dbg !234 ; line:123 col:49
  %17 = extractvalue %dx.types.CBufRet.f32 %14, 2, !dbg !234 ; line:123 col:49
  %18 = extractvalue %dx.types.CBufRet.f32 %14, 3, !dbg !234 ; line:123 col:49
  %19 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPerObject_cbuffer, i32 1), !dbg !234 ; line:123 col:49  ; CBufferLoadLegacy(handle,regIndex)
  %20 = extractvalue %dx.types.CBufRet.f32 %19, 0, !dbg !234 ; line:123 col:49
  %21 = extractvalue %dx.types.CBufRet.f32 %19, 1, !dbg !234 ; line:123 col:49
  %22 = extractvalue %dx.types.CBufRet.f32 %19, 2, !dbg !234 ; line:123 col:49
  %23 = extractvalue %dx.types.CBufRet.f32 %19, 3, !dbg !234 ; line:123 col:49
  %24 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPerObject_cbuffer, i32 2), !dbg !234 ; line:123 col:49  ; CBufferLoadLegacy(handle,regIndex)
  %25 = extractvalue %dx.types.CBufRet.f32 %24, 0, !dbg !234 ; line:123 col:49
  %26 = extractvalue %dx.types.CBufRet.f32 %24, 1, !dbg !234 ; line:123 col:49
  %27 = extractvalue %dx.types.CBufRet.f32 %24, 2, !dbg !234 ; line:123 col:49
  %28 = extractvalue %dx.types.CBufRet.f32 %24, 3, !dbg !234 ; line:123 col:49
  %29 = fmul fast float %.i019, %15, !dbg !235 ; line:123 col:22
  %FMad11 = call float @dx.op.tertiary.f32(i32 46, float %.i121, float %16, float %29), !dbg !235 ; line:123 col:22  ; FMad(a,b,c)
  %FMad10 = call float @dx.op.tertiary.f32(i32 46, float %.i223, float %17, float %FMad11), !dbg !235 ; line:123 col:22  ; FMad(a,b,c)
  %FMad9 = call float @dx.op.tertiary.f32(i32 46, float 1.000000e+00, float %18, float %FMad10), !dbg !235 ; line:123 col:22  ; FMad(a,b,c)
  %30 = fmul fast float %.i019, %20, !dbg !235 ; line:123 col:22
  %FMad8 = call float @dx.op.tertiary.f32(i32 46, float %.i121, float %21, float %30), !dbg !235 ; line:123 col:22  ; FMad(a,b,c)
  %FMad7 = call float @dx.op.tertiary.f32(i32 46, float %.i223, float %22, float %FMad8), !dbg !235 ; line:123 col:22  ; FMad(a,b,c)
  %FMad6 = call float @dx.op.tertiary.f32(i32 46, float 1.000000e+00, float %23, float %FMad7), !dbg !235 ; line:123 col:22  ; FMad(a,b,c)
  %31 = fmul fast float %.i019, %25, !dbg !235 ; line:123 col:22
  %FMad5 = call float @dx.op.tertiary.f32(i32 46, float %.i121, float %26, float %31), !dbg !235 ; line:123 col:22  ; FMad(a,b,c)
  %FMad4 = call float @dx.op.tertiary.f32(i32 46, float %.i223, float %27, float %FMad5), !dbg !235 ; line:123 col:22  ; FMad(a,b,c)
  %FMad3 = call float @dx.op.tertiary.f32(i32 46, float 1.000000e+00, float %28, float %FMad4), !dbg !235 ; line:123 col:22  ; FMad(a,b,c)
  %32 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !235 ; line:123 col:22
  %33 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !236 ; line:123 col:12
  call void @llvm.dbg.value(metadata float %FMad9, i64 0, metadata !237, metadata !231), !dbg !236 ; var:"centerW" !DIExpression(DW_OP_bit_piece, 0, 32) func:"ConstantHS"
  call void @llvm.dbg.value(metadata float %FMad6, i64 0, metadata !237, metadata !232), !dbg !236 ; var:"centerW" !DIExpression(DW_OP_bit_piece, 32, 32) func:"ConstantHS"
  call void @llvm.dbg.value(metadata float %FMad3, i64 0, metadata !237, metadata !233), !dbg !236 ; var:"centerW" !DIExpression(DW_OP_bit_piece, 64, 32) func:"ConstantHS"
  %34 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPass_cbuffer, i32 24), !dbg !238 ; line:125 col:33  ; CBufferLoadLegacy(handle,regIndex)
  %35 = extractvalue %dx.types.CBufRet.f32 %34, 0, !dbg !238 ; line:125 col:33
  %36 = extractvalue %dx.types.CBufRet.f32 %34, 1, !dbg !238 ; line:125 col:33
  %37 = extractvalue %dx.types.CBufRet.f32 %34, 2, !dbg !238 ; line:125 col:33
  %.i024 = fsub fast float %FMad9, %35, !dbg !239 ; line:125 col:15
  %.i125 = fsub fast float %FMad6, %36, !dbg !239 ; line:125 col:15
  %.i226 = fsub fast float %FMad3, %37, !dbg !239 ; line:125 col:15
  %38 = fmul fast float %.i024, %.i024, !dbg !239 ; line:125 col:15
  %39 = fmul fast float %.i125, %.i125, !dbg !239 ; line:125 col:15
  %40 = fadd fast float %38, %39, !dbg !239 ; line:125 col:15
  %41 = fmul fast float %.i226, %.i226, !dbg !239 ; line:125 col:15
  %42 = fadd fast float %40, %41, !dbg !239 ; line:125 col:15
  %Sqrt = call float @dx.op.unary.f32(i32 24, float %42), !dbg !239 ; line:125 col:15  ; Sqrt(value)
  %43 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !240 ; line:125 col:11
  call void @llvm.dbg.value(metadata float %Sqrt, i64 0, metadata !241, metadata !242), !dbg !240 ; var:"d" !DIExpression() func:"ConstantHS"
  %44 = fsub fast float 1.000000e+02, %Sqrt, !dbg !243 ; line:133 col:39
  %45 = fdiv fast float %44, 8.000000e+01, !dbg !244 ; line:133 col:44
  %Saturate = call float @dx.op.unary.f32(i32 7, float %45), !dbg !245 ; line:133 col:26  ; Saturate(value)
  %46 = fmul fast float 6.400000e+01, %Saturate, !dbg !246 ; line:133 col:24
  %47 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !247 ; line:133 col:11
  call void @llvm.dbg.value(metadata float %46, i64 0, metadata !248, metadata !242), !dbg !247 ; var:"tess" !DIExpression() func:"ConstantHS"
  %48 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !249 ; line:137 col:20
  call void @llvm.dbg.value(metadata float %46, i64 0, metadata !250, metadata !231), !dbg !251 ; var:"pt" !DIExpression(DW_OP_bit_piece, 0, 32) func:"ConstantHS"
  %49 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !252 ; line:138 col:20
  call void @llvm.dbg.value(metadata float %46, i64 0, metadata !250, metadata !232), !dbg !251 ; var:"pt" !DIExpression(DW_OP_bit_piece, 32, 32) func:"ConstantHS"
  %50 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !253 ; line:139 col:20
  call void @llvm.dbg.value(metadata float %46, i64 0, metadata !250, metadata !233), !dbg !251 ; var:"pt" !DIExpression(DW_OP_bit_piece, 64, 32) func:"ConstantHS"
  %51 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !254 ; line:140 col:20
  call void @llvm.dbg.value(metadata float %46, i64 0, metadata !250, metadata !255), !dbg !251 ; var:"pt" !DIExpression(DW_OP_bit_piece, 96, 32) func:"ConstantHS"
  %52 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !256 ; line:142 col:22
  call void @llvm.dbg.value(metadata float %46, i64 0, metadata !250, metadata !257), !dbg !251 ; var:"pt" !DIExpression(DW_OP_bit_piece, 128, 32) func:"ConstantHS"
  %53 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !258 ; line:143 col:22
  call void @llvm.dbg.value(metadata float %46, i64 0, metadata !250, metadata !259), !dbg !251 ; var:"pt" !DIExpression(DW_OP_bit_piece, 160, 32) func:"ConstantHS"
  %54 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !260 ; line:145 col:12
  call void @dx.op.storePatchConstant.f32(i32 106, i32 0, i32 0, i8 0, float %46), !dbg !260 ; line:145 col:12  ; StorePatchConstant(outputSigID,row,col,value)
  call void @dx.op.storePatchConstant.f32(i32 106, i32 0, i32 1, i8 0, float %46), !dbg !260 ; line:145 col:12  ; StorePatchConstant(outputSigID,row,col,value)
  call void @dx.op.storePatchConstant.f32(i32 106, i32 0, i32 2, i8 0, float %46), !dbg !260 ; line:145 col:12  ; StorePatchConstant(outputSigID,row,col,value)
  call void @dx.op.storePatchConstant.f32(i32 106, i32 0, i32 3, i8 0, float %46), !dbg !260 ; line:145 col:12  ; StorePatchConstant(outputSigID,row,col,value)
  call void @dx.op.storePatchConstant.f32(i32 106, i32 1, i32 0, i8 0, float %46), !dbg !260 ; line:145 col:12  ; StorePatchConstant(outputSigID,row,col,value)
  call void @dx.op.storePatchConstant.f32(i32 106, i32 1, i32 1, i8 0, float %46), !dbg !260 ; line:145 col:12  ; StorePatchConstant(outputSigID,row,col,value)
  %55 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !261 ; line:145 col:5
  ret void, !dbg !261 ; line:145 col:5
}

define void @HS() {
  %1 = call i32 @dx.op.outputControlPointID.i32(i32 107), !dbg !262 ; line:154 col:37  ; OutputControlPointID()
  call void @llvm.dbg.value(metadata i32 %1, i64 0, metadata !263, metadata !242), !dbg !264 ; var:"i" !DIExpression() func:"HS"
  %2 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !265 ; line:158 col:12
  %3 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 0, i32 %1), !dbg !265 ; line:158 col:12  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  %4 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 1, i32 %1), !dbg !265 ; line:158 col:12  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  %5 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 2, i32 %1), !dbg !265 ; line:158 col:12  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 0, float %3), !dbg !265 ; line:158 col:12  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 1, float %4), !dbg !265 ; line:158 col:12  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 2, float %5), !dbg !265 ; line:158 col:12  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  %6 = call float @dx.op.loadInput.f32(i32 4, i32 1, i32 0, i8 0, i32 %1), !dbg !265 ; line:158 col:12  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  %7 = call float @dx.op.loadInput.f32(i32 4, i32 1, i32 0, i8 1, i32 %1), !dbg !265 ; line:158 col:12  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  %8 = call float @dx.op.loadInput.f32(i32 4, i32 1, i32 0, i8 2, i32 %1), !dbg !265 ; line:158 col:12  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  call void @dx.op.storeOutput.f32(i32 5, i32 1, i32 0, i8 0, float %6), !dbg !265 ; line:158 col:12  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 1, i32 0, i8 1, float %7), !dbg !265 ; line:158 col:12  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 1, i32 0, i8 2, float %8), !dbg !265 ; line:158 col:12  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  %9 = call float @dx.op.loadInput.f32(i32 4, i32 2, i32 0, i8 0, i32 %1), !dbg !265 ; line:158 col:12  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  %10 = call float @dx.op.loadInput.f32(i32 4, i32 2, i32 0, i8 1, i32 %1), !dbg !265 ; line:158 col:12  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  call void @dx.op.storeOutput.f32(i32 5, i32 2, i32 0, i8 0, float %9), !dbg !265 ; line:158 col:12  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 2, i32 0, i8 1, float %10), !dbg !265 ; line:158 col:12  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  %11 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !266 ; line:158 col:5
  ret void, !dbg !266 ; line:158 col:5
}
...
!16 = !{!17, !61}
!17 = !DISubprogram(name: "ConstantHS", linkageName: "\01?ConstantHS@@YA?AUPatchTess@@V?$InputPatch@UVertexIn@@$03@@I@Z", scope: !1, file: !1, line: 118, type: !18, isLocal: false, isDefinition: true, scopeLine: 119, flags: DIFlagPrototyped, isOptimized: false, function: void ()* @"\01?ConstantHS@@YA?AUPatchTess@@V?$InputPatch@UVertexIn@@$03@@I@Z")
...
!61 = !DISubprogram(name: "HS", scope: !1, file: !1, line: 154, type: !62, isLocal: false, isDefinition: true, scopeLine: 157, flags: DIFlagPrototyped, isOptimized: false, function: void ()* @HS)
...
!122 = !DIDerivedType(tag: DW_TAG_member, name: "Strength", scope: !119, file: !120, line: 5, baseType: !39, size: 96, align: 32)
!123 = !DIDerivedType(tag: DW_TAG_member, name: "FalloffStart", scope: !119, file: !120, line: 6, baseType: !8, size: 32, align: 32, offset: 96)
!124 = !DIDerivedType(tag: DW_TAG_member, name: "Direction", scope: !119, file: !120, line: 7, baseType: !39, size: 96, align: 32, offset: 128)
!125 = !DIDerivedType(tag: DW_TAG_member, name: "FalloffEnd", scope: !119, file: !120, line: 8, baseType: !8, size: 32, align: 32, offset: 224)
!126 = !DIDerivedType(tag: DW_TAG_member, name: "Position", scope: !119, file: !120, line: 9, baseType: !39, size: 96, align: 32, offset: 256)
...
!134 = !DIGlobalVariable(name: "d0", scope: !17, file: !1, line: 131, type: !93, isLocal: true, isDefinition: true)
!135 = !DIGlobalVariable(name: "d1", scope: !17, file: !1, line: 132, type: !93, isLocal: true, isDefinition: true)
...
!155 = !{!"-E", !"HS", !"-T", !"hs_6_0", !"-Zi", !"-Qembed_debug", !"-Od", !"-Fo", !"C:\5CUsers\5Ccjw78\5CDesktop\5CD12Engine\5CD12Engine\5CResource\5CShaders\5CCompiled\5CtessHS.cso"}
!156 = !{i32 1, i32 0}
!157 = !{i32 1, i32 8}
!158 = !{!"hs", i32 6, i32 0}
!159 = !{null, null, !160, null}
!160 = !{!161, !162}
!161 = !{i32 0, %hostlayout.cbPerObject* undef, !"cbPerObject", i32 0, i32 0, i32 1, i32 144, null}
!162 = !{i32 1, %hostlayout.cbPass* undef, !"cbPass", i32 0, i32 2, i32 1, i32 1248, null}
!163 = !{i32 0, %struct.Light undef, !164, %hostlayout.cbPerObject undef, !171, %hostlayout.cbPass undef, !178}
!164 = !{i32 48, !165, !166, !167, !168, !169, !170}
!165 = !{i32 6, !"Strength", i32 3, i32 0, i32 7, i32 9}
!166 = !{i32 6, !"FalloffStart", i32 3, i32 12, i32 7, i32 9}
!167 = !{i32 6, !"Direction", i32 3, i32 16, i32 7, i32 9}
!168 = !{i32 6, !"FalloffEnd", i32 3, i32 28, i32 7, i32 9}
!169 = !{i32 6, !"Position", i32 3, i32 32, i32 7, i32 9}
!170 = !{i32 6, !"SpotPower", i32 3, i32 44, i32 7, i32 9}
!171 = !{i32 144, !172, !174, !175, !176, !177}
!172 = !{i32 6, !"gWorld", i32 2, !173, i32 3, i32 0, i32 7, i32 9}
!173 = !{i32 4, i32 4, i32 2}
!174 = !{i32 6, !"gTexTransform", i32 2, !173, i32 3, i32 64, i32 7, i32 9}
!175 = !{i32 6, !"gDisplacementMapTexelSize", i32 3, i32 128, i32 7, i32 9}
!176 = !{i32 6, !"gGridSpatialStep", i32 3, i32 136, i32 7, i32 9}
!177 = !{i32 6, !"cbPerObjectPad1", i32 3, i32 140, i32 7, i32 9}
!178 = !{i32 1248, !179, !180, !181, !182, !183, !184, !185, !186, !187, !188, !189, !190, !191, !192, !193, !194, !195, !196, !197, !198}
!179 = !{i32 6, !"gView", i32 2, !173, i32 3, i32 0, i32 7, i32 9}
!180 = !{i32 6, !"gInvView", i32 2, !173, i32 3, i32 64, i32 7, i32 9}
!181 = !{i32 6, !"gProj", i32 2, !173, i32 3, i32 128, i32 7, i32 9}
!182 = !{i32 6, !"gInvProj", i32 2, !173, i32 3, i32 192, i32 7, i32 9}
!183 = !{i32 6, !"gViewProj", i32 2, !173, i32 3, i32 256, i32 7, i32 9}
!184 = !{i32 6, !"gInvViewProj", i32 2, !173, i32 3, i32 320, i32 7, i32 9}
!185 = !{i32 6, !"gEyePosW", i32 3, i32 384, i32 7, i32 9}
!186 = !{i32 6, !"cbPerPassPad1", i32 3, i32 396, i32 7, i32 9}
!187 = !{i32 6, !"gRenderTargetSize", i32 3, i32 400, i32 7, i32 9}
!188 = !{i32 6, !"gInvRenderTargetSize", i32 3, i32 408, i32 7, i32 9}
!189 = !{i32 6, !"gNearZ", i32 3, i32 416, i32 7, i32 9}
!190 = !{i32 6, !"gFarZ", i32 3, i32 420, i32 7, i32 9}
!191 = !{i32 6, !"gTotalTime", i32 3, i32 424, i32 7, i32 9}
!192 = !{i32 6, !"gDeltaTime", i32 3, i32 428, i32 7, i32 9}
!193 = !{i32 6, !"gAmbientLight", i32 3, i32 432, i32 7, i32 9}
!194 = !{i32 6, !"gLights", i32 3, i32 448}
!195 = !{i32 6, !"gFogColor", i32 3, i32 1216, i32 7, i32 9}
!196 = !{i32 6, !"gFogStart", i32 3, i32 1232, i32 7, i32 9}
!197 = !{i32 6, !"gFogRange", i32 3, i32 1236, i32 7, i32 9}
!198 = !{i32 6, !"cbPerObjectPad2", i32 3, i32 1240, i32 7, i32 9}
!199 = !{i32 1, void ()* @"\01?ConstantHS@@YA?AUPatchTess@@V?$InputPatch@UVertexIn@@$03@@I@Z", !200, void ()* @HS, !200}
!200 = !{!201}
!201 = !{i32 0, !2, !2}
!202 = !{[23 x i32] [i32 10, i32 10, i32 1, i32 2, i32 4, i32 0, i32 16, i32 32, i32 64, i32 0, i32 256, i32 512, i32 24, i32 8947848, i32 8947848, i32 8947848, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0]}
!203 = !{void ()* @HS, !"HS", !204, !159, !218}
!204 = !{!205, !205, !212}
!205 = !{!206, !209, !210}
!206 = !{i32 0, !"POSITION", i8 9, i8 0, !207, i8 2, i32 1, i8 3, i32 0, i8 0, !208}
!207 = !{i32 0}
!208 = !{i32 3, i32 7}
!209 = !{i32 1, !"NORMAL", i8 9, i8 0, !207, i8 2, i32 1, i8 3, i32 1, i8 0, !208}
!210 = !{i32 2, !"TEXCOORD", i8 9, i8 0, !207, i8 2, i32 1, i8 2, i32 2, i8 0, !211}
!211 = !{i32 3, i32 3}
!212 = !{!213, !216}
!213 = !{i32 0, !"SV_TessFactor", i8 9, i8 25, !214, i8 0, i32 4, i8 1, i32 0, i8 3, !215}
!214 = !{i32 0, i32 1, i32 2, i32 3}
!215 = !{i32 3, i32 1}
!216 = !{i32 1, !"SV_InsideTessFactor", i8 9, i8 26, !217, i8 0, i32 2, i8 1, i32 4, i8 3, !215}
!217 = !{i32 0, i32 1}
!218 = !{i32 0, i64 1, i32 3, !219}
!219 = !{void ()* @"\01?ConstantHS@@YA?AUPatchTess@@V?$InputPatch@UVertexIn@@$03@@I@Z", i32 4, i32 4, i32 3, i32 1, i32 3, float 6.400000e+01}
!220 = !DILocation(line: 118, column: 46, scope: !17)
!221 = !DILocation(line: 122, column: 40, scope: !17)
!222 = !DILocation(line: 122, column: 56, scope: !17)
!223 = !DILocation(line: 122, column: 45, scope: !17)
!224 = !DILocation(line: 122, column: 72, scope: !17)
!225 = !DILocation(line: 122, column: 61, scope: !17)
!226 = !DILocation(line: 122, column: 88, scope: !17)
!227 = !DILocation(line: 122, column: 77, scope: !17)
!228 = !DILocation(line: 122, column: 28, scope: !17)
!229 = !DILocation(line: 122, column: 12, scope: !17)
!230 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "centerL", scope: !17, file: !1, line: 122, type: !39)
!231 = !DIExpression(DW_OP_bit_piece, 0, 32)
!232 = !DIExpression(DW_OP_bit_piece, 32, 32)
!233 = !DIExpression(DW_OP_bit_piece, 64, 32)
!234 = !DILocation(line: 123, column: 49, scope: !17)
!235 = !DILocation(line: 123, column: 22, scope: !17)
!236 = !DILocation(line: 123, column: 12, scope: !17)
!237 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "centerW", scope: !17, file: !1, line: 123, type: !39)
!238 = !DILocation(line: 125, column: 33, scope: !17)
!239 = !DILocation(line: 125, column: 15, scope: !17)
!240 = !DILocation(line: 125, column: 11, scope: !17)
!241 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "d", scope: !17, file: !1, line: 125, type: !8)
!242 = !DIExpression()
!243 = !DILocation(line: 133, column: 39, scope: !17)
!244 = !DILocation(line: 133, column: 44, scope: !17)
!245 = !DILocation(line: 133, column: 26, scope: !17)
!246 = !DILocation(line: 133, column: 24, scope: !17)
!247 = !DILocation(line: 133, column: 11, scope: !17)
!248 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "tess", scope: !17, file: !1, line: 133, type: !8)
!249 = !DILocation(line: 137, column: 20, scope: !17)
!250 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "pt", scope: !17, file: !1, line: 120, type: !20)
!251 = !DILocation(line: 120, column: 15, scope: !17)
!252 = !DILocation(line: 138, column: 20, scope: !17)
!253 = !DILocation(line: 139, column: 20, scope: !17)
!254 = !DILocation(line: 140, column: 20, scope: !17)
!255 = !DIExpression(DW_OP_bit_piece, 96, 32)
!256 = !DILocation(line: 142, column: 22, scope: !17)
!257 = !DIExpression(DW_OP_bit_piece, 128, 32)
!258 = !DILocation(line: 143, column: 22, scope: !17)
!259 = !DIExpression(DW_OP_bit_piece, 160, 32)
!260 = !DILocation(line: 145, column: 12, scope: !17)
!261 = !DILocation(line: 145, column: 5, scope: !17)
!262 = !DILocation(line: 154, column: 37, scope: !61)
!263 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "i", arg: 2, scope: !61, file: !1, line: 155, type: !59)
!264 = !DILocation(line: 155, column: 17, scope: !61)
!265 = !DILocation(line: 158, column: 12, scope: !61)
!266 = !DILocation(line: 158, column: 5, scope: !61)
