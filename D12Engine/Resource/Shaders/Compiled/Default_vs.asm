...
define void @VS() {
  %cbPass_cbuffer = call %dx.types.Handle @dx.op.createHandle(i32 57, i8 2, i32 2, i32 2, i1 false), !dbg !217 ; line:85 col:23  ; CreateHandle(resourceClass,rangeId,index,nonUniformIndex)
  %cbMaterial_cbuffer = call %dx.types.Handle @dx.op.createHandle(i32 57, i8 2, i32 1, i32 1, i1 false), !dbg !217 ; line:85 col:23  ; CreateHandle(resourceClass,rangeId,index,nonUniformIndex)
  %cbPerObject_cbuffer = call %dx.types.Handle @dx.op.createHandle(i32 57, i8 2, i32 0, i32 0, i1 false), !dbg !217 ; line:85 col:23  ; CreateHandle(resourceClass,rangeId,index,nonUniformIndex)
  %1 = call float @dx.op.loadInput.f32(i32 4, i32 3, i32 0, i8 0, i32 undef), !dbg !217 ; line:85 col:23  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  ...
  %2 = call float @dx.op.loadInput.f32(i32 4, i32 3, i32 0, i8 1, i32 undef), !dbg !217 ; line:85 col:23  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  ...
  %3 = call float @dx.op.loadInput.f32(i32 4, i32 1, i32 0, i8 0, i32 undef), !dbg !217 ; line:85 col:23  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  ...
  %4 = call float @dx.op.loadInput.f32(i32 4, i32 1, i32 0, i8 1, i32 undef), !dbg !217 ; line:85 col:23  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  ...
  %5 = call float @dx.op.loadInput.f32(i32 4, i32 1, i32 0, i8 2, i32 undef), !dbg !217 ; line:85 col:23  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  ...
  %6 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 0, i32 undef), !dbg !217 ; line:85 col:23  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  ...
  %7 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 1, i32 undef), !dbg !217 ; line:85 col:23  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  ...
  %8 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 2, i32 undef), !dbg !217 ; line:85 col:23  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  call void @llvm.dbg.value(metadata float %1, i64 0, metadata !218, metadata !219), !dbg !217 ; var:"vin" !DIExpression(DW_OP_bit_piece, 288, 32) func:"VS"
  call void @llvm.dbg.value(metadata float %2, i64 0, metadata !218, metadata !220), !dbg !217 ; var:"vin" !DIExpression(DW_OP_bit_piece, 320, 32) func:"VS"
  call void @llvm.dbg.value(metadata float %3, i64 0, metadata !218, metadata !221), !dbg !217 ; var:"vin" !DIExpression(DW_OP_bit_piece, 96, 32) func:"VS"
  call void @llvm.dbg.value(metadata float %4, i64 0, metadata !218, metadata !222), !dbg !217 ; var:"vin" !DIExpression(DW_OP_bit_piece, 128, 32) func:"VS"
  ...
  %9 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !227 ; line:87 col:34
  ...
  %10 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !227 ; line:87 col:34
  ...
  %11 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !227 ; line:87 col:34
  ...
  %12 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !227 ; line:87 col:34
  ...
  %13 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPerObject_cbuffer, i32 0), !dbg !234 ; line:104 col:47  ; CBufferLoadLegacy(handle,regIndex)
  %14 = extractvalue %dx.types.CBufRet.f32 %13, 0, !dbg !234 ; line:104 col:47
  %15 = extractvalue %dx.types.CBufRet.f32 %13, 1, !dbg !234 ; line:104 col:47
  %16 = extractvalue %dx.types.CBufRet.f32 %13, 2, !dbg !234 ; line:104 col:47
  %17 = extractvalue %dx.types.CBufRet.f32 %13, 3, !dbg !234 ; line:104 col:47
  %18 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPerObject_cbuffer, i32 1), !dbg !234 ; line:104 col:47  ; CBufferLoadLegacy(handle,regIndex)
  %19 = extractvalue %dx.types.CBufRet.f32 %18, 0, !dbg !234 ; line:104 col:47
  %20 = extractvalue %dx.types.CBufRet.f32 %18, 1, !dbg !234 ; line:104 col:47
  %21 = extractvalue %dx.types.CBufRet.f32 %18, 2, !dbg !234 ; line:104 col:47
  %22 = extractvalue %dx.types.CBufRet.f32 %18, 3, !dbg !234 ; line:104 col:47
  %23 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPerObject_cbuffer, i32 2), !dbg !234 ; line:104 col:47  ; CBufferLoadLegacy(handle,regIndex)
  %24 = extractvalue %dx.types.CBufRet.f32 %23, 0, !dbg !234 ; line:104 col:47
  %25 = extractvalue %dx.types.CBufRet.f32 %23, 1, !dbg !234 ; line:104 col:47
  %26 = extractvalue %dx.types.CBufRet.f32 %23, 2, !dbg !234 ; line:104 col:47
  %27 = extractvalue %dx.types.CBufRet.f32 %23, 3, !dbg !234 ; line:104 col:47
  %28 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPerObject_cbuffer, i32 3), !dbg !234 ; line:104 col:47  ; CBufferLoadLegacy(handle,regIndex)
  %29 = extractvalue %dx.types.CBufRet.f32 %28, 0, !dbg !234 ; line:104 col:47
  %30 = extractvalue %dx.types.CBufRet.f32 %28, 1, !dbg !234 ; line:104 col:47
  %31 = extractvalue %dx.types.CBufRet.f32 %28, 2, !dbg !234 ; line:104 col:47
  %32 = extractvalue %dx.types.CBufRet.f32 %28, 3, !dbg !234 ; line:104 col:47
  %33 = fmul fast float %6, %14, !dbg !235 ; line:104 col:19
  %FMad57 = call float @dx.op.tertiary.f32(i32 46, float %7, float %15, float %33), !dbg !235 ; line:104 col:19  ; FMad(a,b,c)
  %FMad56 = call float @dx.op.tertiary.f32(i32 46, float %8, float %16, float %FMad57), !dbg !235 ; line:104 col:19  ; FMad(a,b,c)
  %FMad55 = call float @dx.op.tertiary.f32(i32 46, float 1.000000e+00, float %17, float %FMad56), !dbg !235 ; line:104 col:19  ; FMad(a,b,c)
  %34 = fmul fast float %6, %19, !dbg !235 ; line:104 col:19
  %FMad54 = call float @dx.op.tertiary.f32(i32 46, float %7, float %20, float %34), !dbg !235 ; line:104 col:19  ; FMad(a,b,c)
  %FMad53 = call float @dx.op.tertiary.f32(i32 46, float %8, float %21, float %FMad54), !dbg !235 ; line:104 col:19  ; FMad(a,b,c)
  %FMad52 = call float @dx.op.tertiary.f32(i32 46, float 1.000000e+00, float %22, float %FMad53), !dbg !235 ; line:104 col:19  ; FMad(a,b,c)
  %35 = fmul fast float %6, %24, !dbg !235 ; line:104 col:19
  %FMad51 = call float @dx.op.tertiary.f32(i32 46, float %7, float %25, float %35), !dbg !235 ; line:104 col:19  ; FMad(a,b,c)
  %FMad50 = call float @dx.op.tertiary.f32(i32 46, float %8, float %26, float %FMad51), !dbg !235 ; line:104 col:19  ; FMad(a,b,c)
  %FMad49 = call float @dx.op.tertiary.f32(i32 46, float 1.000000e+00, float %27, float %FMad50), !dbg !235 ; line:104 col:19  ; FMad(a,b,c)
  %36 = fmul fast float %6, %29, !dbg !235 ; line:104 col:19
  %FMad48 = call float @dx.op.tertiary.f32(i32 46, float %7, float %30, float %36), !dbg !235 ; line:104 col:19  ; FMad(a,b,c)
  %FMad47 = call float @dx.op.tertiary.f32(i32 46, float %8, float %31, float %FMad48), !dbg !235 ; line:104 col:19  ; FMad(a,b,c)
  %FMad46 = call float @dx.op.tertiary.f32(i32 46, float 1.000000e+00, float %32, float %FMad47), !dbg !235 ; line:104 col:19  ; FMad(a,b,c)
  %37 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !236 ; line:104 col:12
  ...
  %38 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !238 ; line:105 col:15
  ...
  %39 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPerObject_cbuffer, i32 0), !dbg !240 ; line:108 col:48  ; CBufferLoadLegacy(handle,regIndex)
  %40 = extractvalue %dx.types.CBufRet.f32 %39, 0, !dbg !240 ; line:108 col:48
  %41 = extractvalue %dx.types.CBufRet.f32 %39, 1, !dbg !240 ; line:108 col:48
  %42 = extractvalue %dx.types.CBufRet.f32 %39, 2, !dbg !240 ; line:108 col:48
  %43 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPerObject_cbuffer, i32 1), !dbg !240 ; line:108 col:48  ; CBufferLoadLegacy(handle,regIndex)
  %44 = extractvalue %dx.types.CBufRet.f32 %43, 0, !dbg !240 ; line:108 col:48
  %45 = extractvalue %dx.types.CBufRet.f32 %43, 1, !dbg !240 ; line:108 col:48
  %46 = extractvalue %dx.types.CBufRet.f32 %43, 2, !dbg !240 ; line:108 col:48
  %47 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPerObject_cbuffer, i32 2), !dbg !240 ; line:108 col:48  ; CBufferLoadLegacy(handle,regIndex)
  %48 = extractvalue %dx.types.CBufRet.f32 %47, 0, !dbg !240 ; line:108 col:48
  %49 = extractvalue %dx.types.CBufRet.f32 %47, 1, !dbg !240 ; line:108 col:48
  %50 = extractvalue %dx.types.CBufRet.f32 %47, 2, !dbg !240 ; line:108 col:48
  %51 = fmul fast float %3, %40, !dbg !241 ; line:108 col:20
  %FMad45 = call float @dx.op.tertiary.f32(i32 46, float %4, float %41, float %51), !dbg !241 ; line:108 col:20  ; FMad(a,b,c)
  %FMad44 = call float @dx.op.tertiary.f32(i32 46, float %5, float %42, float %FMad45), !dbg !241 ; line:108 col:20  ; FMad(a,b,c)
  %52 = fmul fast float %3, %44, !dbg !241 ; line:108 col:20
  %FMad43 = call float @dx.op.tertiary.f32(i32 46, float %4, float %45, float %52), !dbg !241 ; line:108 col:20  ; FMad(a,b,c)
  %FMad42 = call float @dx.op.tertiary.f32(i32 46, float %5, float %46, float %FMad43), !dbg !241 ; line:108 col:20  ; FMad(a,b,c)
  %53 = fmul fast float %3, %48, !dbg !241 ; line:108 col:20
  %FMad41 = call float @dx.op.tertiary.f32(i32 46, float %4, float %49, float %53), !dbg !241 ; line:108 col:20  ; FMad(a,b,c)
  %FMad40 = call float @dx.op.tertiary.f32(i32 46, float %5, float %50, float %FMad41), !dbg !241 ; line:108 col:20  ; FMad(a,b,c)
  %54 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !242 ; line:108 col:18
  ...
  %55 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPass_cbuffer, i32 16), !dbg !245 ; line:111 col:27  ; CBufferLoadLegacy(handle,regIndex)
  %56 = extractvalue %dx.types.CBufRet.f32 %55, 0, !dbg !245 ; line:111 col:27
  %57 = extractvalue %dx.types.CBufRet.f32 %55, 1, !dbg !245 ; line:111 col:27
  %58 = extractvalue %dx.types.CBufRet.f32 %55, 2, !dbg !245 ; line:111 col:27
  %59 = extractvalue %dx.types.CBufRet.f32 %55, 3, !dbg !245 ; line:111 col:27
  %60 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPass_cbuffer, i32 17), !dbg !245 ; line:111 col:27  ; CBufferLoadLegacy(handle,regIndex)
  %61 = extractvalue %dx.types.CBufRet.f32 %60, 0, !dbg !245 ; line:111 col:27
  %62 = extractvalue %dx.types.CBufRet.f32 %60, 1, !dbg !245 ; line:111 col:27
  %63 = extractvalue %dx.types.CBufRet.f32 %60, 2, !dbg !245 ; line:111 col:27
  %64 = extractvalue %dx.types.CBufRet.f32 %60, 3, !dbg !245 ; line:111 col:27
  %65 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPass_cbuffer, i32 18), !dbg !245 ; line:111 col:27  ; CBufferLoadLegacy(handle,regIndex)
  %66 = extractvalue %dx.types.CBufRet.f32 %65, 0, !dbg !245 ; line:111 col:27
  %67 = extractvalue %dx.types.CBufRet.f32 %65, 1, !dbg !245 ; line:111 col:27
  %68 = extractvalue %dx.types.CBufRet.f32 %65, 2, !dbg !245 ; line:111 col:27
  %69 = extractvalue %dx.types.CBufRet.f32 %65, 3, !dbg !245 ; line:111 col:27
  %70 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPass_cbuffer, i32 19), !dbg !245 ; line:111 col:27  ; CBufferLoadLegacy(handle,regIndex)
  %71 = extractvalue %dx.types.CBufRet.f32 %70, 0, !dbg !245 ; line:111 col:27
  %72 = extractvalue %dx.types.CBufRet.f32 %70, 1, !dbg !245 ; line:111 col:27
  %73 = extractvalue %dx.types.CBufRet.f32 %70, 2, !dbg !245 ; line:111 col:27
  %74 = extractvalue %dx.types.CBufRet.f32 %70, 3, !dbg !245 ; line:111 col:27
  %75 = fmul fast float %FMad55, %56, !dbg !246 ; line:111 col:17
  %FMad39 = call float @dx.op.tertiary.f32(i32 46, float %FMad52, float %57, float %75), !dbg !246 ; line:111 col:17  ; FMad(a,b,c)
  %FMad38 = call float @dx.op.tertiary.f32(i32 46, float %FMad49, float %58, float %FMad39), !dbg !246 ; line:111 col:17  ; FMad(a,b,c)
  %FMad37 = call float @dx.op.tertiary.f32(i32 46, float %FMad46, float %59, float %FMad38), !dbg !246 ; line:111 col:17  ; FMad(a,b,c)
  %76 = fmul fast float %FMad55, %61, !dbg !246 ; line:111 col:17
  %FMad36 = call float @dx.op.tertiary.f32(i32 46, float %FMad52, float %62, float %76), !dbg !246 ; line:111 col:17  ; FMad(a,b,c)
  %FMad35 = call float @dx.op.tertiary.f32(i32 46, float %FMad49, float %63, float %FMad36), !dbg !246 ; line:111 col:17  ; FMad(a,b,c)
  %FMad34 = call float @dx.op.tertiary.f32(i32 46, float %FMad46, float %64, float %FMad35), !dbg !246 ; line:111 col:17  ; FMad(a,b,c)
  %77 = fmul fast float %FMad55, %66, !dbg !246 ; line:111 col:17
  %FMad33 = call float @dx.op.tertiary.f32(i32 46, float %FMad52, float %67, float %77), !dbg !246 ; line:111 col:17  ; FMad(a,b,c)
  %FMad32 = call float @dx.op.tertiary.f32(i32 46, float %FMad49, float %68, float %FMad33), !dbg !246 ; line:111 col:17  ; FMad(a,b,c)
  %FMad31 = call float @dx.op.tertiary.f32(i32 46, float %FMad46, float %69, float %FMad32), !dbg !246 ; line:111 col:17  ; FMad(a,b,c)
  %78 = fmul fast float %FMad55, %71, !dbg !246 ; line:111 col:17
  %FMad30 = call float @dx.op.tertiary.f32(i32 46, float %FMad52, float %72, float %78), !dbg !246 ; line:111 col:17  ; FMad(a,b,c)
  %FMad29 = call float @dx.op.tertiary.f32(i32 46, float %FMad49, float %73, float %FMad30), !dbg !246 ; line:111 col:17  ; FMad(a,b,c)
  %FMad28 = call float @dx.op.tertiary.f32(i32 46, float %FMad46, float %74, float %FMad29), !dbg !246 ; line:111 col:17  ; FMad(a,b,c)
  %79 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !247 ; line:111 col:15
  ...
  %80 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPerObject_cbuffer, i32 4), !dbg !248 ; line:113 col:51  ; CBufferLoadLegacy(handle,regIndex)
  %81 = extractvalue %dx.types.CBufRet.f32 %80, 0, !dbg !248 ; line:113 col:51
  %82 = extractvalue %dx.types.CBufRet.f32 %80, 1, !dbg !248 ; line:113 col:51
  %83 = extractvalue %dx.types.CBufRet.f32 %80, 2, !dbg !248 ; line:113 col:51
  %84 = extractvalue %dx.types.CBufRet.f32 %80, 3, !dbg !248 ; line:113 col:51
  %85 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPerObject_cbuffer, i32 5), !dbg !248 ; line:113 col:51  ; CBufferLoadLegacy(handle,regIndex)
  %86 = extractvalue %dx.types.CBufRet.f32 %85, 0, !dbg !248 ; line:113 col:51
  %87 = extractvalue %dx.types.CBufRet.f32 %85, 1, !dbg !248 ; line:113 col:51
  %88 = extractvalue %dx.types.CBufRet.f32 %85, 2, !dbg !248 ; line:113 col:51
  %89 = extractvalue %dx.types.CBufRet.f32 %85, 3, !dbg !248 ; line:113 col:51
  %90 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPerObject_cbuffer, i32 6), !dbg !248 ; line:113 col:51  ; CBufferLoadLegacy(handle,regIndex)
  %91 = extractvalue %dx.types.CBufRet.f32 %90, 0, !dbg !248 ; line:113 col:51
  %92 = extractvalue %dx.types.CBufRet.f32 %90, 1, !dbg !248 ; line:113 col:51
  %93 = extractvalue %dx.types.CBufRet.f32 %90, 2, !dbg !248 ; line:113 col:51
  %94 = extractvalue %dx.types.CBufRet.f32 %90, 3, !dbg !248 ; line:113 col:51
  %95 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPerObject_cbuffer, i32 7), !dbg !248 ; line:113 col:51  ; CBufferLoadLegacy(handle,regIndex)
  %96 = extractvalue %dx.types.CBufRet.f32 %95, 0, !dbg !248 ; line:113 col:51
  %97 = extractvalue %dx.types.CBufRet.f32 %95, 1, !dbg !248 ; line:113 col:51
  %98 = extractvalue %dx.types.CBufRet.f32 %95, 2, !dbg !248 ; line:113 col:51
  %99 = extractvalue %dx.types.CBufRet.f32 %95, 3, !dbg !248 ; line:113 col:51
  %100 = fmul fast float %1, %81, !dbg !249 ; line:113 col:19
  %FMad27 = call float @dx.op.tertiary.f32(i32 46, float %2, float %82, float %100), !dbg !249 ; line:113 col:19  ; FMad(a,b,c)
  %FMad26 = call float @dx.op.tertiary.f32(i32 46, float 0.000000e+00, float %83, float %FMad27), !dbg !249 ; line:113 col:19  ; FMad(a,b,c)
  %FMad25 = call float @dx.op.tertiary.f32(i32 46, float 1.000000e+00, float %84, float %FMad26), !dbg !249 ; line:113 col:19  ; FMad(a,b,c)
  %101 = fmul fast float %1, %86, !dbg !249 ; line:113 col:19
  %FMad24 = call float @dx.op.tertiary.f32(i32 46, float %2, float %87, float %101), !dbg !249 ; line:113 col:19  ; FMad(a,b,c)
  %FMad23 = call float @dx.op.tertiary.f32(i32 46, float 0.000000e+00, float %88, float %FMad24), !dbg !249 ; line:113 col:19  ; FMad(a,b,c)
  %FMad22 = call float @dx.op.tertiary.f32(i32 46, float 1.000000e+00, float %89, float %FMad23), !dbg !249 ; line:113 col:19  ; FMad(a,b,c)
  %102 = fmul fast float %1, %91, !dbg !249 ; line:113 col:19
  %FMad21 = call float @dx.op.tertiary.f32(i32 46, float %2, float %92, float %102), !dbg !249 ; line:113 col:19  ; FMad(a,b,c)
  %FMad20 = call float @dx.op.tertiary.f32(i32 46, float 0.000000e+00, float %93, float %FMad21), !dbg !249 ; line:113 col:19  ; FMad(a,b,c)
  %FMad19 = call float @dx.op.tertiary.f32(i32 46, float 1.000000e+00, float %94, float %FMad20), !dbg !249 ; line:113 col:19  ; FMad(a,b,c)
  %103 = fmul fast float %1, %96, !dbg !249 ; line:113 col:19
  %FMad18 = call float @dx.op.tertiary.f32(i32 46, float %2, float %97, float %103), !dbg !249 ; line:113 col:19  ; FMad(a,b,c)
  %FMad17 = call float @dx.op.tertiary.f32(i32 46, float 0.000000e+00, float %98, float %FMad18), !dbg !249 ; line:113 col:19  ; FMad(a,b,c)
  %FMad16 = call float @dx.op.tertiary.f32(i32 46, float 1.000000e+00, float %99, float %FMad17), !dbg !249 ; line:113 col:19  ; FMad(a,b,c)
  %104 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !250 ; line:113 col:12
  ...
  %105 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbMaterial_cbuffer, i32 2), !dbg !252 ; line:114 col:27  ; CBufferLoadLegacy(handle,regIndex)
  %106 = extractvalue %dx.types.CBufRet.f32 %105, 0, !dbg !252 ; line:114 col:27
  %107 = extractvalue %dx.types.CBufRet.f32 %105, 1, !dbg !252 ; line:114 col:27
  %108 = extractvalue %dx.types.CBufRet.f32 %105, 2, !dbg !252 ; line:114 col:27
  %109 = extractvalue %dx.types.CBufRet.f32 %105, 3, !dbg !252 ; line:114 col:27
  %110 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbMaterial_cbuffer, i32 3), !dbg !252 ; line:114 col:27  ; CBufferLoadLegacy(handle,regIndex)
  %111 = extractvalue %dx.types.CBufRet.f32 %110, 0, !dbg !252 ; line:114 col:27
  %112 = extractvalue %dx.types.CBufRet.f32 %110, 1, !dbg !252 ; line:114 col:27
  %113 = extractvalue %dx.types.CBufRet.f32 %110, 2, !dbg !252 ; line:114 col:27
  %114 = extractvalue %dx.types.CBufRet.f32 %110, 3, !dbg !252 ; line:114 col:27
  %115 = fmul fast float %FMad25, %106, !dbg !253 ; line:114 col:17
  %FMad15 = call float @dx.op.tertiary.f32(i32 46, float %FMad22, float %107, float %115), !dbg !253 ; line:114 col:17  ; FMad(a,b,c)
  %FMad14 = call float @dx.op.tertiary.f32(i32 46, float %FMad19, float %108, float %FMad15), !dbg !253 ; line:114 col:17  ; FMad(a,b,c)
  %FMad13 = call float @dx.op.tertiary.f32(i32 46, float %FMad16, float %109, float %FMad14), !dbg !253 ; line:114 col:17  ; FMad(a,b,c)
  %116 = fmul fast float %FMad25, %111, !dbg !253 ; line:114 col:17
  %FMad12 = call float @dx.op.tertiary.f32(i32 46, float %FMad22, float %112, float %116), !dbg !253 ; line:114 col:17  ; FMad(a,b,c)
  %FMad11 = call float @dx.op.tertiary.f32(i32 46, float %FMad19, float %113, float %FMad12), !dbg !253 ; line:114 col:17  ; FMad(a,b,c)
  %FMad10 = call float @dx.op.tertiary.f32(i32 46, float %FMad16, float %114, float %FMad11), !dbg !253 ; line:114 col:17  ; FMad(a,b,c)
  %117 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !253 ; line:114 col:17
  %118 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !254 ; line:114 col:15
  ...
  %119 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !256 ; line:116 col:12
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 0, float %FMad37), !dbg !256 ; line:116 col:12  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 1, float %FMad34), !dbg !256 ; line:116 col:12  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 2, float %FMad31), !dbg !256 ; line:116 col:12  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 3, float %FMad28), !dbg !256 ; line:116 col:12  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 1, i32 0, i8 0, float %FMad55), !dbg !256 ; line:116 col:12  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 1, i32 0, i8 1, float %FMad52), !dbg !256 ; line:116 col:12  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 1, i32 0, i8 2, float %FMad49), !dbg !256 ; line:116 col:12  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 2, i32 0, i8 0, float %FMad44), !dbg !256 ; line:116 col:12  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 2, i32 0, i8 1, float %FMad42), !dbg !256 ; line:116 col:12  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 2, i32 0, i8 2, float %FMad40), !dbg !256 ; line:116 col:12  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 3, i32 0, i8 0, float %FMad13), !dbg !256 ; line:116 col:12  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 3, i32 0, i8 1, float %FMad10), !dbg !256 ; line:116 col:12  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  %120 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !257 ; line:116 col:5
  ret void, !dbg !257 ; line:116 col:5
}
...
!31 = !{!32}
!32 = !DISubprogram(name: "VS", scope: !1, file: !1, line: 85, type: !33, isLocal: false, isDefinition: true, scopeLine: 86, flags: DIFlagPrototyped, isOptimized: false, function: void ()* @VS)
!33 = !DISubroutineType(types: !34)
!34 = !{!35, !56}
!35 = !DICompositeType(tag: DW_TAG_structure_type, name: "VertexOut", file: !1, line: 77, size: 384, align: 32, elements: !36)
!36 = !{!37, !38, !47, !48}
!37 = !DIDerivedType(tag: DW_TAG_member, name: "PosH", scope: !35, file: !1, line: 79, baseType: !4, size: 128, align: 32)
!38 = !DIDerivedType(tag: DW_TAG_member, name: "PosW", scope: !35, file: !1, line: 80, baseType: !39, size: 96, align: 32, offset: 128)
!39 = !DIDerivedType(tag: DW_TAG_typedef, name: "float3", file: !1, line: 33, baseType: !40)
!40 = !DICompositeType(tag: DW_TAG_class_type, name: "vector<float, 3>", file: !1, line: 33, size: 96, align: 32, elements: !41, templateParams: !45)
!41 = !{!42, !43, !44}
!42 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !40, file: !1, line: 33, baseType: !8, size: 32, align: 32, flags: DIFlagPublic)
!43 = !DIDerivedType(tag: DW_TAG_member, name: "y", scope: !40, file: !1, line: 33, baseType: !8, size: 32, align: 32, offset: 32, flags: DIFlagPublic)
!44 = !DIDerivedType(tag: DW_TAG_member, name: "z", scope: !40, file: !1, line: 33, baseType: !8, size: 32, align: 32, offset: 64, flags: DIFlagPublic)
!45 = !{!13, !46}
!46 = !DITemplateValueParameter(name: "element_count", type: !15, value: i32 3)
!47 = !DIDerivedType(tag: DW_TAG_member, name: "NormalW", scope: !35, file: !1, line: 81, baseType: !39, size: 96, align: 32, offset: 224)
!48 = !DIDerivedType(tag: DW_TAG_member, name: "TexC", scope: !35, file: !1, line: 82, baseType: !49, size: 64, align: 32, offset: 320)
!49 = !DIDerivedType(tag: DW_TAG_typedef, name: "float2", file: !1, line: 25, baseType: !50)
!50 = !DICompositeType(tag: DW_TAG_class_type, name: "vector<float, 2>", file: !1, line: 25, size: 64, align: 32, elements: !51, templateParams: !54)
!51 = !{!52, !53}
!52 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !50, file: !1, line: 25, baseType: !8, size: 32, align: 32, flags: DIFlagPublic)
!53 = !DIDerivedType(tag: DW_TAG_member, name: "y", scope: !50, file: !1, line: 25, baseType: !8, size: 32, align: 32, offset: 32, flags: DIFlagPublic)
!54 = !{!13, !55}
...
!57 = !{!58, !59, !60, !61}
!58 = !DIDerivedType(tag: DW_TAG_member, name: "PosL", scope: !56, file: !1, line: 71, baseType: !39, size: 96, align: 32)
!59 = !DIDerivedType(tag: DW_TAG_member, name: "NormalL", scope: !56, file: !1, line: 72, baseType: !39, size: 96, align: 32, offset: 96)
!60 = !DIDerivedType(tag: DW_TAG_member, name: "TangentL", scope: !56, file: !1, line: 73, baseType: !39, size: 96, align: 32, offset: 192)
!61 = !DIDerivedType(tag: DW_TAG_member, name: "TexC", scope: !56, file: !1, line: 74, baseType: !49, size: 64, align: 32, offset: 288)
...
!145 = !{!"C:\5CUsers\5Ccjw78\5CDesktop\5CCopyDX\5CCopyDX\5CResource\5CShaders\5CDefault.hlsl"}
!146 = !{!"-E", !"VS", !"-T", !"vs_6_0", !"-Zi", !"-Qembed_debug", !"-Od", !"-Fo", !"C:\5CUsers\5Ccjw78\5CDesktop\5CCopyDX\5CCopyDX\5CResource\5CShaders\5CCompiled\5CDefault_vs.cso"}
!147 = !{i32 1, i32 0}
!148 = !{i32 1, i32 8}
!149 = !{!"vs", i32 6, i32 0}
...
!216 = !{i32 0, i64 1}
!217 = !DILocation(line: 85, column: 23, scope: !32)
!218 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "vin", arg: 1, scope: !32, file: !1, line: 85, type: !56)
...
!227 = !DILocation(line: 87, column: 34, scope: !32)
!228 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "vout", scope: !32, file: !1, line: 87, type: !35)
!229 = !DIExpression(DW_OP_bit_piece, 0, 128)
!230 = !DILocation(line: 87, column: 15, scope: !32)
!231 = !DIExpression(DW_OP_bit_piece, 128, 96)
!232 = !DIExpression(DW_OP_bit_piece, 224, 96)
!233 = !DIExpression(DW_OP_bit_piece, 320, 64)
!234 = !DILocation(line: 104, column: 47, scope: !32)
!235 = !DILocation(line: 104, column: 19, scope: !32)
!236 = !DILocation(line: 104, column: 12, scope: !32)
!237 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "posW", scope: !32, file: !1, line: 104, type: !4)
!238 = !DILocation(line: 105, column: 15, scope: !32)
!239 = !DIExpression(DW_OP_bit_piece, 192, 32)
!240 = !DILocation(line: 108, column: 48, scope: !32)
!241 = !DILocation(line: 108, column: 20, scope: !32)
!242 = !DILocation(line: 108, column: 18, scope: !32)
!243 = !DIExpression(DW_OP_bit_piece, 224, 32)
!244 = !DIExpression(DW_OP_bit_piece, 256, 32)
!245 = !DILocation(line: 111, column: 27, scope: !32)
!246 = !DILocation(line: 111, column: 17, scope: !32)
!247 = !DILocation(line: 111, column: 15, scope: !32)
!248 = !DILocation(line: 113, column: 51, scope: !32)
!249 = !DILocation(line: 113, column: 19, scope: !32)
!250 = !DILocation(line: 113, column: 12, scope: !32)
!251 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "texC", scope: !32, file: !1, line: 113, type: !4)
!252 = !DILocation(line: 114, column: 27, scope: !32)
!253 = !DILocation(line: 114, column: 17, scope: !32)
!254 = !DILocation(line: 114, column: 15, scope: !32)
!255 = !DIExpression(DW_OP_bit_piece, 352, 32)
!256 = !DILocation(line: 116, column: 12, scope: !32)
!257 = !DILocation(line: 116, column: 5, scope: !32)
