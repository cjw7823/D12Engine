...
define void @PS() {
  %gDiffuseMap2_texture_2d = call %dx.types.Handle @dx.op.createHandle(i32 57, i8 0, i32 1, i32 1, i1 false), !dbg !211 ; line:123 col:28  ; CreateHandle(resourceClass,rangeId,index,nonUniformIndex)
  %gDiffuseMap_texture_2d = call %dx.types.Handle @dx.op.createHandle(i32 57, i8 0, i32 0, i32 0, i1 false), !dbg !211 ; line:123 col:28  ; CreateHandle(resourceClass,rangeId,index,nonUniformIndex)
  %gsamLinear_sampler = call %dx.types.Handle @dx.op.createHandle(i32 57, i8 3, i32 0, i32 0, i1 false), !dbg !211 ; line:123 col:28  ; CreateHandle(resourceClass,rangeId,index,nonUniformIndex)
  %cbPass_cbuffer = call %dx.types.Handle @dx.op.createHandle(i32 57, i8 2, i32 1, i32 2, i1 false), !dbg !211 ; line:123 col:28  ; CreateHandle(resourceClass,rangeId,index,nonUniformIndex)
  %cbMaterial_cbuffer = call %dx.types.Handle @dx.op.createHandle(i32 57, i8 2, i32 0, i32 1, i1 false), !dbg !211 ; line:123 col:28  ; CreateHandle(resourceClass,rangeId,index,nonUniformIndex)
  ...
  call void @llvm.dbg.value(metadata float %1, i64 0, metadata !212, metadata !213), !dbg !214 ; var:"pin" !DIExpression(DW_OP_bit_piece, 320, 32) func:"PS"
  call void @llvm.dbg.value(metadata float %2, i64 0, metadata !212, metadata !215), !dbg !214 ; var:"pin" !DIExpression(DW_OP_bit_piece, 352, 32) func:"PS"
  %10 = call %dx.types.ResRet.f32 @dx.op.sample.f32(i32 60, %dx.types.Handle %gDiffuseMap_texture_2d, %dx.types.Handle %gsamLinear_sampler, float %1, float %2, float undef, float undef, i32 0, i32 0, i32 undef, float undef), !dbg !211 ; line:123 col:28  ; Sample(srv,sampler,coord0,coord1,coord2,coord3,offset0,offset1,offset2,clamp)
  %11 = extractvalue %dx.types.ResRet.f32 %10, 0, !dbg !211 ; line:123 col:28
  %12 = extractvalue %dx.types.ResRet.f32 %10, 1, !dbg !211 ; line:123 col:28
  %13 = extractvalue %dx.types.ResRet.f32 %10, 2, !dbg !211 ; line:123 col:28
  %14 = extractvalue %dx.types.ResRet.f32 %10, 3, !dbg !211 ; line:123 col:28
  %15 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbMaterial_cbuffer, i32 0), !dbg !222 ; line:123 col:71  ; CBufferLoadLegacy(handle,regIndex)
  %16 = extractvalue %dx.types.CBufRet.f32 %15, 0, !dbg !222 ; line:123 col:71
  %17 = extractvalue %dx.types.CBufRet.f32 %15, 1, !dbg !222 ; line:123 col:71
  %18 = extractvalue %dx.types.CBufRet.f32 %15, 2, !dbg !222 ; line:123 col:71
  %19 = extractvalue %dx.types.CBufRet.f32 %15, 3, !dbg !222 ; line:123 col:71
  %.i0 = fmul fast float %11, %16, !dbg !223 ; line:123 col:69
  %.i1 = fmul fast float %12, %17, !dbg !223 ; line:123 col:69
  %.i2 = fmul fast float %13, %18, !dbg !223 ; line:123 col:69
  %.i3 = fmul fast float %14, %19, !dbg !223 ; line:123 col:69
  %20 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !224 ; line:123 col:12
  ...
  %21 = call %dx.types.ResRet.f32 @dx.op.sample.f32(i32 60, %dx.types.Handle %gDiffuseMap2_texture_2d, %dx.types.Handle %gsamLinear_sampler, float %1, float %2, float undef, float undef, i32 0, i32 0, i32 undef, float undef), !dbg !230 ; line:126 col:23  ; Sample(srv,sampler,coord0,coord1,coord2,coord3,offset0,offset1,offset2,clamp)
  %22 = extractvalue %dx.types.ResRet.f32 %21, 0, !dbg !230 ; line:126 col:23
  %23 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbMaterial_cbuffer, i32 0), !dbg !231 ; line:126 col:67  ; CBufferLoadLegacy(handle,regIndex)
  %24 = extractvalue %dx.types.CBufRet.f32 %23, 0, !dbg !231 ; line:126 col:67
  %.i06 = fmul fast float %22, %24, !dbg !232 ; line:126 col:65
  %25 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !233 ; line:126 col:22
  %.i010 = fmul fast float %.i0, %.i06, !dbg !234 ; line:126 col:19
  %.i111 = fmul fast float %.i1, %.i06, !dbg !234 ; line:126 col:19
  %.i212 = fmul fast float %.i2, %.i06, !dbg !234 ; line:126 col:19
  %.i313 = fmul fast float %.i3, %.i06, !dbg !234 ; line:126 col:19
  %26 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !234 ; line:126 col:19
  ...
  %27 = call float @dx.op.dot3.f32(i32 55, float %3, float %4, float %5, float %3, float %4, float %5), !dbg !235 ; line:135 col:19  ; Dot3(ax,ay,az,bx,by,bz)
  %Rsqrt1 = call float @dx.op.unary.f32(i32 25, float %27), !dbg !235 ; line:135 col:19  ; Rsqrt(value)
  %.i014 = fmul fast float %3, %Rsqrt1, !dbg !235 ; line:135 col:19
  %.i115 = fmul fast float %4, %Rsqrt1, !dbg !235 ; line:135 col:19
  %.i216 = fmul fast float %5, %Rsqrt1, !dbg !235 ; line:135 col:19
  %28 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !236 ; line:135 col:17
  ...
  %29 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPass_cbuffer, i32 24), !dbg !237 ; line:138 col:21  ; CBufferLoadLegacy(handle,regIndex)
  %30 = extractvalue %dx.types.CBufRet.f32 %29, 0, !dbg !237 ; line:138 col:21
  %31 = extractvalue %dx.types.CBufRet.f32 %29, 1, !dbg !237 ; line:138 col:21
  %32 = extractvalue %dx.types.CBufRet.f32 %29, 2, !dbg !237 ; line:138 col:21
  %.i017 = fsub fast float %30, %6, !dbg !238 ; line:138 col:30
  %.i118 = fsub fast float %31, %7, !dbg !238 ; line:138 col:30
  %.i219 = fsub fast float %32, %8, !dbg !238 ; line:138 col:30
  %33 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !239 ; line:138 col:12
  ...
  %34 = fmul fast float %.i017, %.i017, !dbg !241 ; line:139 col:23
  %35 = fmul fast float %.i118, %.i118, !dbg !241 ; line:139 col:23
  %36 = fadd fast float %34, %35, !dbg !241 ; line:139 col:23
  %37 = fmul fast float %.i219, %.i219, !dbg !241 ; line:139 col:23
  %38 = fadd fast float %36, %37, !dbg !241 ; line:139 col:23
  %Sqrt = call float @dx.op.unary.f32(i32 24, float %38), !dbg !241 ; line:139 col:23  ; Sqrt(value)
  %39 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !242 ; line:139 col:11
  call void @llvm.dbg.value(metadata float %Sqrt, i64 0, metadata !243, metadata !244), !dbg !242 ; var:"distToEye" !DIExpression() func:"PS"
  %.i020 = fdiv fast float %.i017, %Sqrt, !dbg !245 ; line:140 col:12
  %.i121 = fdiv fast float %.i118, %Sqrt, !dbg !245 ; line:140 col:12
  %.i222 = fdiv fast float %.i219, %Sqrt, !dbg !245 ; line:140 col:12
  %40 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !245 ; line:140 col:12
  ...
  %41 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPass_cbuffer, i32 27), !dbg !246 ; line:142 col:22  ; CBufferLoadLegacy(handle,regIndex)
  %42 = extractvalue %dx.types.CBufRet.f32 %41, 0, !dbg !246 ; line:142 col:22
  %43 = extractvalue %dx.types.CBufRet.f32 %41, 1, !dbg !246 ; line:142 col:22
  %44 = extractvalue %dx.types.CBufRet.f32 %41, 2, !dbg !246 ; line:142 col:22
  %.i023 = fmul fast float %42, %.i010, !dbg !247 ; line:142 col:36
  %.i124 = fmul fast float %43, %.i111, !dbg !247 ; line:142 col:36
  %.i225 = fmul fast float %44, %.i212, !dbg !247 ; line:142 col:36
  %45 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !248 ; line:142 col:12
  ...
  %46 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbMaterial_cbuffer, i32 1), !dbg !250 ; line:143 col:36  ; CBufferLoadLegacy(handle,regIndex)
  %47 = extractvalue %dx.types.CBufRet.f32 %46, 3, !dbg !250 ; line:143 col:36
  %48 = fsub fast float 1.000000e+00, %47, !dbg !251 ; line:143 col:34
  %49 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !252 ; line:143 col:17
  call void @llvm.dbg.value(metadata float %48, i64 0, metadata !253, metadata !244), !dbg !252 ; var:"shininess" !DIExpression() func:"PS"
  %50 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !254 ; line:144 col:20
  ...
  %51 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbMaterial_cbuffer, i32 1), !dbg !269 ; line:144 col:37  ; CBufferLoadLegacy(handle,regIndex)
  %52 = extractvalue %dx.types.CBufRet.f32 %51, 0, !dbg !269 ; line:144 col:37
  ...
  %53 = extractvalue %dx.types.CBufRet.f32 %51, 1, !dbg !269 ; line:144 col:37
  ...
  %54 = extractvalue %dx.types.CBufRet.f32 %51, 2, !dbg !269 ; line:144 col:37
  ...
  %55 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !254 ; line:144 col:20
  ...
  %56 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !254 ; line:144 col:20
  ...
  %57 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !273 ; line:145 col:12
  ...
  %58 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !275 ; line:147 col:26
  %59 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !275 ; line:147 col:26
  %60 = getelementptr inbounds [3 x float], [3 x float]* %9, i32 0, i32 0, !dbg !275 ; line:147 col:26
  store float 1.000000e+00, float* %60, align 4, !dbg !275 ; line:147 col:26
  %61 = getelementptr inbounds [3 x float], [3 x float]* %9, i32 0, i32 1, !dbg !275 ; line:147 col:26
  store float 1.000000e+00, float* %61, align 4, !dbg !275 ; line:147 col:26
  %62 = getelementptr inbounds [3 x float], [3 x float]* %9, i32 0, i32 2, !dbg !275 ; line:147 col:26
  store float 1.000000e+00, float* %62, align 4, !dbg !275 ; line:147 col:26
  ...
  %63 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !280 ; line:196 col:12
  ...
  %64 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !282 ; line:197 col:9
  call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !283, metadata !244), !dbg !282 ; var:"i" !DIExpression() func:"ComputeLighting"
  %65 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !284 ; line:200 col:11
  call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !283, metadata !244), !dbg !282 ; var:"i" !DIExpression() func:"ComputeLighting"
  br label %.lr.ph, !dbg !285 ; line:200 col:5

.lr.ph:                                           ; preds = %0
  br label %66, !dbg !285 ; line:200 col:5
...
; <label>:66                                      ; preds = %66, %.lr.ph
  ...
  %67 = getelementptr [3 x float], [3 x float]* %9, i32 0, i32 %i.i.0, !dbg !286 ; line:202 col:19
  %68 = load float, float* %67, !dbg !286 ; line:202 col:19
  %69 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !287 ; line:202 col:37
  %70 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !287 ; line:202 col:37
  %71 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !287 ; line:202 col:37
  ...
  %72 = mul i32 %i.i.0, 3, !dbg !292 ; line:118 col:26
  %73 = add i32 28, %72, !dbg !292 ; line:118 col:26
  %74 = add i32 %73, 1, !dbg !292 ; line:118 col:26
  %75 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPass_cbuffer, i32 %74), !dbg !292 ; line:118 col:26  ; CBufferLoadLegacy(handle,regIndex)
  %76 = extractvalue %dx.types.CBufRet.f32 %75, 0, !dbg !292 ; line:118 col:26
  %77 = extractvalue %dx.types.CBufRet.f32 %75, 1, !dbg !292 ; line:118 col:26
  %78 = extractvalue %dx.types.CBufRet.f32 %75, 2, !dbg !292 ; line:118 col:26
  %.i031 = fsub fast float -0.000000e+00, %76, !dbg !293 ; line:118 col:23
  %.i133 = fsub fast float -0.000000e+00, %77, !dbg !293 ; line:118 col:23
  %.i235 = fsub fast float -0.000000e+00, %78, !dbg !293 ; line:118 col:23
  %79 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !294 ; line:118 col:12
  ...
  %80 = call float @dx.op.dot3.f32(i32 55, float %.i031, float %.i133, float %.i235, float %.i014, float %.i115, float %.i216), !dbg !296 ; line:121 col:23  ; Dot3(ax,ay,az,bx,by,bz)
  %FMax5 = call float @dx.op.binary.f32(i32 35, float %80, float 0.000000e+00), !dbg !297 ; line:121 col:19  ; FMax(a,b)
  %81 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !298 ; line:121 col:11
  ...
  %82 = mul i32 %i.i.0, 3, !dbg !300 ; line:127 col:30
  %83 = add i32 28, %82, !dbg !300 ; line:127 col:30
  %84 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPass_cbuffer, i32 %83), !dbg !300 ; line:127 col:30  ; CBufferLoadLegacy(handle,regIndex)
  %85 = extractvalue %dx.types.CBufRet.f32 %84, 0, !dbg !300 ; line:127 col:30
  %86 = extractvalue %dx.types.CBufRet.f32 %84, 1, !dbg !300 ; line:127 col:30
  %87 = extractvalue %dx.types.CBufRet.f32 %84, 2, !dbg !300 ; line:127 col:30
  %.i036 = fmul fast float %85, %FMax5, !dbg !301 ; line:127 col:39
  %.i137 = fmul fast float %86, %FMax5, !dbg !301 ; line:127 col:39
  %.i238 = fmul fast float %87, %FMax5, !dbg !301 ; line:127 col:39
  %88 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !302 ; line:127 col:12
  call void @llvm.dbg.value(metadata float %.i036, i64 0, metadata !303, metadata !226), !dbg !302 ; var:"lightStrength" !DIExpression(DW_OP_bit_piece, 0, 32) func:"ComputeDirectionalLight"
  call void @llvm.dbg.value(metadata float %.i137, i64 0, metadata !303, metadata !227), !dbg !302 ; var:"lightStrength" !DIExpression(DW_OP_bit_piece, 32, 32) func:"ComputeDirectionalLight"
  call void @llvm.dbg.value(metadata float %.i238, i64 0, metadata !303, metadata !228), !dbg !302 ; var:"lightStrength" !DIExpression(DW_OP_bit_piece, 64, 32) func:"ComputeDirectionalLight"
  %89 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !304 ; line:128 col:12
  %90 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !304 ; line:128 col:12
  ...
  %113 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !358 ; line:128 col:5
  %.i075 = fmul fast float %68, %.i072, !dbg !359 ; line:202 col:35
  %.i176 = fmul fast float %68, %.i173, !dbg !359 ; line:202 col:35
  %.i277 = fmul fast float %68, %.i274, !dbg !359 ; line:202 col:35
  %.i027 = fadd fast float %result.i.0.i0, %.i075, !dbg !360 ; line:202 col:16
  %.i128 = fadd fast float %result.i.0.i1, %.i176, !dbg !360 ; line:202 col:16
  %.i229 = fadd fast float %result.i.0.i2, %.i277, !dbg !360 ; line:202 col:16
  %114 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !360 ; line:202 col:16
  ...
  %115 = add nsw i32 %i.i.0, 1, !dbg !361 ; line:200 col:36
  %116 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !361 ; line:200 col:36
  ...
  %117 = icmp slt i32 %115, 3, !dbg !362 ; line:200 col:18
  br i1 %117, label %66, label %".\01?ComputeLighting@@YA?AV?$vector@M$03@@Y0BA@ULight@@UMaterial@@V?$vector@M$02@@222@Z.exit_crit_edge", !dbg !285 ; line:200 col:5

".\01?ComputeLighting@@YA?AV?$vector@M$03@@Y0BA@ULight@@UMaterial@@V?$vector@M$02@@222@Z.exit_crit_edge": ; preds = %66
  br label %"\01?ComputeLighting@@YA?AV?$vector@M$03@@Y0BA@ULight@@UMaterial@@V?$vector@M$02@@222@Z.exit", !dbg !285 ; line:200 col:5
...
"\01?ComputeLighting@@YA?AV?$vector@M$03@@Y0BA@ULight@@UMaterial@@V?$vector@M$02@@222@Z.exit": ; preds = %".\01?ComputeLighting@@YA?AV?$vector@M$03@@Y0BA@ULight@@UMaterial@@V?$vector@M$02@@222@Z.exit_crit_edge"
  ...
  call void @llvm.dbg.value(metadata float %.i128, i64 0, metadata !281, metadata !227), !dbg !280 ; var:"result" !DIExpression(DW_OP_bit_piece, 32, 32) func:"ComputeLighting"
  call void @llvm.dbg.value(metadata float %.i229, i64 0, metadata !281, metadata !228), !dbg !280 ; var:"result" !DIExpression(DW_OP_bit_piece, 64, 32) func:"ComputeLighting"
  %118 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !363 ; line:220 col:5
  %119 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !364 ; line:147 col:12
  ...
  %.i081 = fadd fast float %.i023, %.i027, !dbg !366 ; line:150 col:31
  %.i182 = fadd fast float %.i124, %.i128, !dbg !366 ; line:150 col:31
  %.i283 = fadd fast float %.i225, %.i229, !dbg !366 ; line:150 col:31
  %120 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !367 ; line:150 col:12
  ...
  %121 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPass_cbuffer, i32 77), !dbg !369 ; line:153 col:45  ; CBufferLoadLegacy(handle,regIndex)
  %122 = extractvalue %dx.types.CBufRet.f32 %121, 0, !dbg !369 ; line:153 col:45
  %123 = fsub fast float %Sqrt, %122, !dbg !370 ; line:153 col:43
  %124 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPass_cbuffer, i32 77), !dbg !371 ; line:153 col:58  ; CBufferLoadLegacy(handle,regIndex)
  %125 = extractvalue %dx.types.CBufRet.f32 %124, 1, !dbg !371 ; line:153 col:58
  %126 = fdiv fast float %123, %125, !dbg !372 ; line:153 col:56
  %Saturate2 = call float @dx.op.unary.f32(i32 7, float %126), !dbg !373 ; line:153 col:23  ; Saturate(value)
  %127 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !374 ; line:153 col:11
  ...
  %128 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPass_cbuffer, i32 76), !dbg !376 ; line:154 col:31  ; CBufferLoadLegacy(handle,regIndex)
  %129 = extractvalue %dx.types.CBufRet.f32 %128, 0, !dbg !376 ; line:154 col:31
  %130 = extractvalue %dx.types.CBufRet.f32 %128, 1, !dbg !376 ; line:154 col:31
  %131 = extractvalue %dx.types.CBufRet.f32 %128, 2, !dbg !376 ; line:154 col:31
  %.i085 = fsub fast float %129, %.i081, !dbg !377 ; line:154 col:16
  %.i186 = fsub fast float %130, %.i182, !dbg !377 ; line:154 col:16
  %.i287 = fsub fast float %131, %.i283, !dbg !377 ; line:154 col:16
  %.i089 = fmul fast float %Saturate2, %.i085, !dbg !377 ; line:154 col:16
  %.i190 = fmul fast float %Saturate2, %.i186, !dbg !377 ; line:154 col:16
  %.i291 = fmul fast float %Saturate2, %.i287, !dbg !377 ; line:154 col:16
  %.i093 = fadd fast float %.i081, %.i089, !dbg !377 ; line:154 col:16
  %.i194 = fadd fast float %.i182, %.i190, !dbg !377 ; line:154 col:16
  %.i295 = fadd fast float %.i283, %.i291, !dbg !377 ; line:154 col:16
  %132 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !378 ; line:154 col:14
  ...
  %133 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !379 ; line:158 col:16
  call void @llvm.dbg.value(metadata float %.i093, i64 0, metadata !368, metadata !226), !dbg !367 ; var:"litColor" !DIExpression(DW_OP_bit_piece, 0, 32) func:"PS"
  call void @llvm.dbg.value(metadata float %.i194, i64 0, metadata !368, metadata !227), !dbg !367 ; var:"litColor" !DIExpression(DW_OP_bit_piece, 32, 32) func:"PS"
  call void @llvm.dbg.value(metadata float %.i295, i64 0, metadata !368, metadata !228), !dbg !367 ; var:"litColor" !DIExpression(DW_OP_bit_piece, 64, 32) func:"PS"
  ...
  %134 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !380 ; line:160 col:5
  ...
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 0, float %.i093), !dbg !380 ; line:160 col:5  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 1, float %.i194), !dbg !380 ; line:160 col:5  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 2, float %.i295), !dbg !380 ; line:160 col:5  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 3, float %.i313), !dbg !380 ; line:160 col:5  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  ret void, !dbg !380 ; line:160 col:5
}
...
!144 = !{!"-E", !"PS", !"-T", !"ps_6_0", !"-Zi", !"-Qembed_debug", !"-Od", !"-D", !"FOG=1", !"-D", !"TEXTURE_BLEND=1", !"-Fo", !"C:\5CUsers\5Ccjw78\5CDesktop\5CD12Engine\5CD12Engine\5CResource\5CShaders\5CCompiled\5CDefault_ps_TextureBlend.cso", !"-D", !"FOG=1", !"-D", !"TEXTURE_BLEND=1"}
!145 = !{i32 1, i32 0}
!146 = !{i32 1, i32 8}
!147 = !{!"ps", i32 6, i32 0}
...
!209 = !{i32 3, i32 15}
!210 = !{i32 0, i64 1}
!211 = !DILocation(line: 123, column: 28, scope: !17)
!212 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "pin", arg: 1, scope: !17, file: !1, line: 121, type: !20)
!213 = !DIExpression(DW_OP_bit_piece, 320, 32)
!214 = !DILocation(line: 121, column: 21, scope: !17)
...
!222 = !DILocation(line: 123, column: 71, scope: !17)
!223 = !DILocation(line: 123, column: 69, scope: !17)
!224 = !DILocation(line: 123, column: 12, scope: !17)
!225 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "diffuseAlbedo", scope: !17, file: !1, line: 123, type: !4)
...
!230 = !DILocation(line: 126, column: 23, scope: !17)
!231 = !DILocation(line: 126, column: 67, scope: !17)
!232 = !DILocation(line: 126, column: 65, scope: !17)
!233 = !DILocation(line: 126, column: 22, scope: !17)
!234 = !DILocation(line: 126, column: 19, scope: !17)
!235 = !DILocation(line: 135, column: 19, scope: !17)
!236 = !DILocation(line: 135, column: 17, scope: !17)
!237 = !DILocation(line: 138, column: 21, scope: !17)
!238 = !DILocation(line: 138, column: 30, scope: !17)
!239 = !DILocation(line: 138, column: 12, scope: !17)
!240 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "toEyeW", scope: !17, file: !1, line: 138, type: !24)
!241 = !DILocation(line: 139, column: 23, scope: !17)
!242 = !DILocation(line: 139, column: 11, scope: !17)
!243 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "distToEye", scope: !17, file: !1, line: 139, type: !8)
!244 = !DIExpression()
!245 = !DILocation(line: 140, column: 12, scope: !17)
!246 = !DILocation(line: 142, column: 22, scope: !17)
!247 = !DILocation(line: 142, column: 36, scope: !17)
!248 = !DILocation(line: 142, column: 12, scope: !17)
!249 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "ambient", scope: !17, file: !1, line: 142, type: !4)
!250 = !DILocation(line: 143, column: 36, scope: !17)
!251 = !DILocation(line: 143, column: 34, scope: !17)
!252 = !DILocation(line: 143, column: 17, scope: !17)
!253 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "shininess", scope: !17, file: !1, line: 143, type: !99)
!254 = !DILocation(line: 144, column: 20, scope: !17)
!255 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "mat", scope: !17, file: !1, line: 144, type: !56)
!256 = !DILocation(line: 144, column: 14, scope: !17)
!257 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "mat", arg: 2, scope: !41, file: !42, line: 194, type: !56)
!258 = !DILocation(line: 194, column: 59, scope: !41, inlinedAt: !259)
!259 = distinct !DILocation(line: 147, column: 26, scope: !17)
...
!262 = distinct !DILocation(line: 128, column: 12, scope: !61, inlinedAt: !263)
!263 = distinct !DILocation(line: 202, column: 37, scope: !264, inlinedAt: !259)
!264 = distinct !DILexicalBlock(scope: !265, file: !42, line: 201, column: 5)
!265 = distinct !DILexicalBlock(scope: !266, file: !42, line: 200, column: 5)
!266 = distinct !DILexicalBlock(scope: !41, file: !42, line: 200, column: 5)
!267 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "mat", arg: 2, scope: !61, file: !42, line: 115, type: !56)
!268 = !DILocation(line: 115, column: 50, scope: !61, inlinedAt: !263)
!269 = !DILocation(line: 144, column: 37, scope: !17)
...
!273 = !DILocation(line: 145, column: 12, scope: !17)
!274 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "shadowFactor", scope: !17, file: !1, line: 145, type: !24)
!275 = !DILocation(line: 147, column: 26, scope: !17)
!276 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "toEye", arg: 5, scope: !41, file: !42, line: 194, type: !24)
!277 = !DILocation(line: 194, column: 98, scope: !41, inlinedAt: !259)
!278 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "normal", arg: 4, scope: !41, file: !42, line: 194, type: !24)
!279 = !DILocation(line: 194, column: 83, scope: !41, inlinedAt: !259)
!280 = !DILocation(line: 196, column: 12, scope: !41, inlinedAt: !259)
!281 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "result", scope: !41, file: !42, line: 196, type: !24)
!282 = !DILocation(line: 197, column: 9, scope: !41, inlinedAt: !259)
!283 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "i", scope: !41, file: !42, line: 197, type: !15)
!284 = !DILocation(line: 200, column: 11, scope: !266, inlinedAt: !259)
!285 = !DILocation(line: 200, column: 5, scope: !266, inlinedAt: !259)
!286 = !DILocation(line: 202, column: 19, scope: !264, inlinedAt: !259)
!287 = !DILocation(line: 202, column: 37, scope: !264, inlinedAt: !259)
!288 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "toEye", arg: 4, scope: !61, file: !42, line: 115, type: !24)
!289 = !DILocation(line: 115, column: 77, scope: !61, inlinedAt: !263)
!290 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "normal", arg: 3, scope: !61, file: !42, line: 115, type: !24)
!291 = !DILocation(line: 115, column: 62, scope: !61, inlinedAt: !263)
!292 = !DILocation(line: 118, column: 26, scope: !61, inlinedAt: !263)
!293 = !DILocation(line: 118, column: 23, scope: !61, inlinedAt: !263)
!294 = !DILocation(line: 118, column: 12, scope: !61, inlinedAt: !263)
!295 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "lightVec", scope: !61, file: !42, line: 118, type: !24)
!296 = !DILocation(line: 121, column: 23, scope: !61, inlinedAt: !263)
!297 = !DILocation(line: 121, column: 19, scope: !61, inlinedAt: !263)
!298 = !DILocation(line: 121, column: 11, scope: !61, inlinedAt: !263)
!299 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "ndotl", scope: !61, file: !42, line: 121, type: !8)
!300 = !DILocation(line: 127, column: 30, scope: !61, inlinedAt: !263)
!301 = !DILocation(line: 127, column: 39, scope: !61, inlinedAt: !263)
!302 = !DILocation(line: 127, column: 12, scope: !61, inlinedAt: !263)
!303 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "lightStrength", scope: !61, file: !42, line: 127, type: !24)
!304 = !DILocation(line: 128, column: 12, scope: !61, inlinedAt: !263)
...
!358 = !DILocation(line: 128, column: 5, scope: !61, inlinedAt: !263)
!359 = !DILocation(line: 202, column: 35, scope: !264, inlinedAt: !259)
!360 = !DILocation(line: 202, column: 16, scope: !264, inlinedAt: !259)
!361 = !DILocation(line: 200, column: 36, scope: !265, inlinedAt: !259)
!362 = !DILocation(line: 200, column: 18, scope: !265, inlinedAt: !259)
!363 = !DILocation(line: 220, column: 5, scope: !41, inlinedAt: !259)
!364 = !DILocation(line: 147, column: 12, scope: !17)
!365 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "directLight", scope: !17, file: !1, line: 147, type: !4)
!366 = !DILocation(line: 150, column: 31, scope: !17)
!367 = !DILocation(line: 150, column: 12, scope: !17)
!368 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "litColor", scope: !17, file: !1, line: 150, type: !4)
!369 = !DILocation(line: 153, column: 45, scope: !17)
!370 = !DILocation(line: 153, column: 43, scope: !17)
!371 = !DILocation(line: 153, column: 58, scope: !17)
!372 = !DILocation(line: 153, column: 56, scope: !17)
!373 = !DILocation(line: 153, column: 23, scope: !17)
!374 = !DILocation(line: 153, column: 11, scope: !17)
!375 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "fogAmount", scope: !17, file: !1, line: 153, type: !8)
!376 = !DILocation(line: 154, column: 31, scope: !17)
!377 = !DILocation(line: 154, column: 16, scope: !17)
!378 = !DILocation(line: 154, column: 14, scope: !17)
!379 = !DILocation(line: 158, column: 16, scope: !17)
!380 = !DILocation(line: 160, column: 5, scope: !17)
!381 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "shadowFactor", arg: 6, scope: !41, file: !42, line: 194, type: !24)
!382 = !DILocation(line: 194, column: 112, scope: !41, inlinedAt: !259)
