...
!144 = !{!"-E", !"PS", !"-T", !"ps_6_0", !"-Zi", !"-Qembed_debug", !"-Od", !"-D", !"FOG=1", !"-D", !"ALPHA_TEST=1", !"-Fo", !"C:\5CUsers\5Ccjw78\5CDesktop\5CCopyDX\5CCopyDX\5CResource\5CShaders\5CCompiled\5CDefault_ps_AlphaTest.cso", !"-D", !"FOG=1", !"-D", !"ALPHA_TEST=1"}
!145 = !{i32 1, i32 0}
!146 = !{i32 1, i32 8}
!147 = !{!"ps", i32 6, i32 0}
