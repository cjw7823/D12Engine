...
define void @PS() {
  ...
  %21 = fsub fast float %.i3, 0x3FB99999A0000000, !dbg !229 ; line:131 col:23
  %22 = fcmp fast olt float %21, 0.000000e+00, !dbg !230 ; line:131 col:2
  call void @dx.op.discard(i32 82, i1 %22), !dbg !230 ; line:131 col:2  ; Discard(condition)
  %23 = call float @dx.op.dot3.f32(i32 55, float %3, float %4, float %5, float %3, float %4, float %5), !dbg !231 ; line:135 col:19  ; Dot3(ax,ay,az,bx,by,bz)
  %Rsqrt1 = call float @dx.op.unary.f32(i32 25, float %23), !dbg !231 ; line:135 col:19  ; Rsqrt(value)
  %.i06 = fmul fast float %3, %Rsqrt1, !dbg !231 ; line:135 col:19
  %.i17 = fmul fast float %4, %Rsqrt1, !dbg !231 ; line:135 col:19
  %.i28 = fmul fast float %5, %Rsqrt1, !dbg !231 ; line:135 col:19
  %24 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !232 ; line:135 col:17
  ...
  %25 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPass_cbuffer, i32 24), !dbg !233 ; line:138 col:21  ; CBufferLoadLegacy(handle,regIndex)
  %26 = extractvalue %dx.types.CBufRet.f32 %25, 0, !dbg !233 ; line:138 col:21
  %27 = extractvalue %dx.types.CBufRet.f32 %25, 1, !dbg !233 ; line:138 col:21
  %28 = extractvalue %dx.types.CBufRet.f32 %25, 2, !dbg !233 ; line:138 col:21
  %.i09 = fsub fast float %26, %6, !dbg !234 ; line:138 col:30
  %.i110 = fsub fast float %27, %7, !dbg !234 ; line:138 col:30
  %.i211 = fsub fast float %28, %8, !dbg !234 ; line:138 col:30
  %29 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !235 ; line:138 col:12
  ...
  %30 = fmul fast float %.i09, %.i09, !dbg !237 ; line:139 col:23
  %31 = fmul fast float %.i110, %.i110, !dbg !237 ; line:139 col:23
  %32 = fadd fast float %30, %31, !dbg !237 ; line:139 col:23
  %33 = fmul fast float %.i211, %.i211, !dbg !237 ; line:139 col:23
  %34 = fadd fast float %32, %33, !dbg !237 ; line:139 col:23
  %Sqrt = call float @dx.op.unary.f32(i32 24, float %34), !dbg !237 ; line:139 col:23  ; Sqrt(value)
  %35 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !238 ; line:139 col:11
  call void @llvm.dbg.value(metadata float %Sqrt, i64 0, metadata !239, metadata !240), !dbg !238 ; var:"distToEye" !DIExpression() func:"PS"
  %.i012 = fdiv fast float %.i09, %Sqrt, !dbg !241 ; line:140 col:12
  %.i113 = fdiv fast float %.i110, %Sqrt, !dbg !241 ; line:140 col:12
  %.i214 = fdiv fast float %.i211, %Sqrt, !dbg !241 ; line:140 col:12
  %36 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !241 ; line:140 col:12
  ...
  %37 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPass_cbuffer, i32 27), !dbg !242 ; line:142 col:22  ; CBufferLoadLegacy(handle,regIndex)
  %38 = extractvalue %dx.types.CBufRet.f32 %37, 0, !dbg !242 ; line:142 col:22
  %39 = extractvalue %dx.types.CBufRet.f32 %37, 1, !dbg !242 ; line:142 col:22
  %40 = extractvalue %dx.types.CBufRet.f32 %37, 2, !dbg !242 ; line:142 col:22
  %.i015 = fmul fast float %38, %.i0, !dbg !243 ; line:142 col:36
  %.i116 = fmul fast float %39, %.i1, !dbg !243 ; line:142 col:36
  %.i217 = fmul fast float %40, %.i2, !dbg !243 ; line:142 col:36
  %41 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !244 ; line:142 col:12
  ...
  %42 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbMaterial_cbuffer, i32 1), !dbg !246 ; line:143 col:36  ; CBufferLoadLegacy(handle,regIndex)
  %43 = extractvalue %dx.types.CBufRet.f32 %42, 3, !dbg !246 ; line:143 col:36
  %44 = fsub fast float 1.000000e+00, %43, !dbg !247 ; line:143 col:34
  %45 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !248 ; line:143 col:17
  call void @llvm.dbg.value(metadata float %44, i64 0, metadata !249, metadata !240), !dbg !248 ; var:"shininess" !DIExpression() func:"PS"
  %46 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !250 ; line:144 col:20
  ...
  %47 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbMaterial_cbuffer, i32 1), !dbg !265 ; line:144 col:37  ; CBufferLoadLegacy(handle,regIndex)
  %48 = extractvalue %dx.types.CBufRet.f32 %47, 0, !dbg !265 ; line:144 col:37
  ...
  %49 = extractvalue %dx.types.CBufRet.f32 %47, 1, !dbg !265 ; line:144 col:37
  ...
  %50 = extractvalue %dx.types.CBufRet.f32 %47, 2, !dbg !265 ; line:144 col:37
  ...
  %51 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !250 ; line:144 col:20
  ...
  %52 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !250 ; line:144 col:20
  ...
  %53 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !269 ; line:145 col:12
  ...
  %54 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !271 ; line:147 col:26
  %55 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !271 ; line:147 col:26
  %56 = getelementptr inbounds [3 x float], [3 x float]* %9, i32 0, i32 0, !dbg !271 ; line:147 col:26
  store float 1.000000e+00, float* %56, align 4, !dbg !271 ; line:147 col:26
  %57 = getelementptr inbounds [3 x float], [3 x float]* %9, i32 0, i32 1, !dbg !271 ; line:147 col:26
  store float 1.000000e+00, float* %57, align 4, !dbg !271 ; line:147 col:26
  %58 = getelementptr inbounds [3 x float], [3 x float]* %9, i32 0, i32 2, !dbg !271 ; line:147 col:26
  store float 1.000000e+00, float* %58, align 4, !dbg !271 ; line:147 col:26
  ...
  %59 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !276 ; line:196 col:12
  ...
  %60 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !278 ; line:197 col:9
  call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !279, metadata !240), !dbg !278 ; var:"i" !DIExpression() func:"ComputeLighting"
  %61 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !280 ; line:200 col:11
  call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !279, metadata !240), !dbg !278 ; var:"i" !DIExpression() func:"ComputeLighting"
  br label %.lr.ph, !dbg !281 ; line:200 col:5

.lr.ph:                                           ; preds = %0
  br label %62, !dbg !281 ; line:200 col:5
...
; <label>:62                                      ; preds = %62, %.lr.ph
  ...
  %63 = getelementptr [3 x float], [3 x float]* %9, i32 0, i32 %i.i.0, !dbg !282 ; line:202 col:19
  %64 = load float, float* %63, !dbg !282 ; line:202 col:19
  %65 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !283 ; line:202 col:37
  %66 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !283 ; line:202 col:37
  %67 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !283 ; line:202 col:37
  ...
  %68 = mul i32 %i.i.0, 3, !dbg !288 ; line:118 col:26
  %69 = add i32 28, %68, !dbg !288 ; line:118 col:26
  %70 = add i32 %69, 1, !dbg !288 ; line:118 col:26
  %71 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPass_cbuffer, i32 %70), !dbg !288 ; line:118 col:26  ; CBufferLoadLegacy(handle,regIndex)
  %72 = extractvalue %dx.types.CBufRet.f32 %71, 0, !dbg !288 ; line:118 col:26
  %73 = extractvalue %dx.types.CBufRet.f32 %71, 1, !dbg !288 ; line:118 col:26
  %74 = extractvalue %dx.types.CBufRet.f32 %71, 2, !dbg !288 ; line:118 col:26
  %.i023 = fsub fast float -0.000000e+00, %72, !dbg !289 ; line:118 col:23
  %.i125 = fsub fast float -0.000000e+00, %73, !dbg !289 ; line:118 col:23
  %.i227 = fsub fast float -0.000000e+00, %74, !dbg !289 ; line:118 col:23
  %75 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !290 ; line:118 col:12
  ...
  %76 = call float @dx.op.dot3.f32(i32 55, float %.i023, float %.i125, float %.i227, float %.i06, float %.i17, float %.i28), !dbg !292 ; line:121 col:23  ; Dot3(ax,ay,az,bx,by,bz)
  %FMax5 = call float @dx.op.binary.f32(i32 35, float %76, float 0.000000e+00), !dbg !293 ; line:121 col:19  ; FMax(a,b)
  %77 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !294 ; line:121 col:11
  ...
  %78 = mul i32 %i.i.0, 3, !dbg !296 ; line:127 col:30
  %79 = add i32 28, %78, !dbg !296 ; line:127 col:30
  %80 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPass_cbuffer, i32 %79), !dbg !296 ; line:127 col:30  ; CBufferLoadLegacy(handle,regIndex)
  %81 = extractvalue %dx.types.CBufRet.f32 %80, 0, !dbg !296 ; line:127 col:30
  %82 = extractvalue %dx.types.CBufRet.f32 %80, 1, !dbg !296 ; line:127 col:30
  %83 = extractvalue %dx.types.CBufRet.f32 %80, 2, !dbg !296 ; line:127 col:30
  %.i028 = fmul fast float %81, %FMax5, !dbg !297 ; line:127 col:39
  %.i129 = fmul fast float %82, %FMax5, !dbg !297 ; line:127 col:39
  %.i230 = fmul fast float %83, %FMax5, !dbg !297 ; line:127 col:39
  %84 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !298 ; line:127 col:12
  call void @llvm.dbg.value(metadata float %.i028, i64 0, metadata !299, metadata !225), !dbg !298 ; var:"lightStrength" !DIExpression(DW_OP_bit_piece, 0, 32) func:"ComputeDirectionalLight"
  call void @llvm.dbg.value(metadata float %.i129, i64 0, metadata !299, metadata !226), !dbg !298 ; var:"lightStrength" !DIExpression(DW_OP_bit_piece, 32, 32) func:"ComputeDirectionalLight"
  call void @llvm.dbg.value(metadata float %.i230, i64 0, metadata !299, metadata !227), !dbg !298 ; var:"lightStrength" !DIExpression(DW_OP_bit_piece, 64, 32) func:"ComputeDirectionalLight"
  %85 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !300 ; line:128 col:12
  %86 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !300 ; line:128 col:12
  ...
  %109 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !354 ; line:128 col:5
  %.i067 = fmul fast float %64, %.i064, !dbg !355 ; line:202 col:35
  %.i168 = fmul fast float %64, %.i165, !dbg !355 ; line:202 col:35
  %.i269 = fmul fast float %64, %.i266, !dbg !355 ; line:202 col:35
  %.i019 = fadd fast float %result.i.0.i0, %.i067, !dbg !356 ; line:202 col:16
  %.i120 = fadd fast float %result.i.0.i1, %.i168, !dbg !356 ; line:202 col:16
  %.i221 = fadd fast float %result.i.0.i2, %.i269, !dbg !356 ; line:202 col:16
  %110 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !356 ; line:202 col:16
  ...
  %111 = add nsw i32 %i.i.0, 1, !dbg !357 ; line:200 col:36
  %112 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !357 ; line:200 col:36
  ...
  %113 = icmp slt i32 %111, 3, !dbg !358 ; line:200 col:18
  br i1 %113, label %62, label %".\01?ComputeLighting@@YA?AV?$vector@M$03@@Y0BA@ULight@@UMaterial@@V?$vector@M$02@@222@Z.exit_crit_edge", !dbg !281 ; line:200 col:5

".\01?ComputeLighting@@YA?AV?$vector@M$03@@Y0BA@ULight@@UMaterial@@V?$vector@M$02@@222@Z.exit_crit_edge": ; preds = %62
  br label %"\01?ComputeLighting@@YA?AV?$vector@M$03@@Y0BA@ULight@@UMaterial@@V?$vector@M$02@@222@Z.exit", !dbg !281 ; line:200 col:5
...
"\01?ComputeLighting@@YA?AV?$vector@M$03@@Y0BA@ULight@@UMaterial@@V?$vector@M$02@@222@Z.exit": ; preds = %".\01?ComputeLighting@@YA?AV?$vector@M$03@@Y0BA@ULight@@UMaterial@@V?$vector@M$02@@222@Z.exit_crit_edge"
  ...
  call void @llvm.dbg.value(metadata float %.i120, i64 0, metadata !277, metadata !226), !dbg !276 ; var:"result" !DIExpression(DW_OP_bit_piece, 32, 32) func:"ComputeLighting"
  call void @llvm.dbg.value(metadata float %.i221, i64 0, metadata !277, metadata !227), !dbg !276 ; var:"result" !DIExpression(DW_OP_bit_piece, 64, 32) func:"ComputeLighting"
  %114 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !359 ; line:220 col:5
  %115 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !360 ; line:147 col:12
  ...
  %.i073 = fadd fast float %.i015, %.i019, !dbg !362 ; line:150 col:31
  %.i174 = fadd fast float %.i116, %.i120, !dbg !362 ; line:150 col:31
  %.i275 = fadd fast float %.i217, %.i221, !dbg !362 ; line:150 col:31
  %116 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !363 ; line:150 col:12
  ...
  %117 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPass_cbuffer, i32 77), !dbg !365 ; line:153 col:45  ; CBufferLoadLegacy(handle,regIndex)
  %118 = extractvalue %dx.types.CBufRet.f32 %117, 0, !dbg !365 ; line:153 col:45
  %119 = fsub fast float %Sqrt, %118, !dbg !366 ; line:153 col:43
  %120 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPass_cbuffer, i32 77), !dbg !367 ; line:153 col:58  ; CBufferLoadLegacy(handle,regIndex)
  %121 = extractvalue %dx.types.CBufRet.f32 %120, 1, !dbg !367 ; line:153 col:58
  %122 = fdiv fast float %119, %121, !dbg !368 ; line:153 col:56
  %Saturate2 = call float @dx.op.unary.f32(i32 7, float %122), !dbg !369 ; line:153 col:23  ; Saturate(value)
  %123 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !370 ; line:153 col:11
  ...
  %124 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPass_cbuffer, i32 76), !dbg !372 ; line:154 col:31  ; CBufferLoadLegacy(handle,regIndex)
  %125 = extractvalue %dx.types.CBufRet.f32 %124, 0, !dbg !372 ; line:154 col:31
  %126 = extractvalue %dx.types.CBufRet.f32 %124, 1, !dbg !372 ; line:154 col:31
  %127 = extractvalue %dx.types.CBufRet.f32 %124, 2, !dbg !372 ; line:154 col:31
  %.i077 = fsub fast float %125, %.i073, !dbg !373 ; line:154 col:16
  %.i178 = fsub fast float %126, %.i174, !dbg !373 ; line:154 col:16
  %.i279 = fsub fast float %127, %.i275, !dbg !373 ; line:154 col:16
  %.i081 = fmul fast float %Saturate2, %.i077, !dbg !373 ; line:154 col:16
  %.i182 = fmul fast float %Saturate2, %.i178, !dbg !373 ; line:154 col:16
  %.i283 = fmul fast float %Saturate2, %.i279, !dbg !373 ; line:154 col:16
  %.i085 = fadd fast float %.i073, %.i081, !dbg !373 ; line:154 col:16
  %.i186 = fadd fast float %.i174, %.i182, !dbg !373 ; line:154 col:16
  %.i287 = fadd fast float %.i275, %.i283, !dbg !373 ; line:154 col:16
  %128 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !374 ; line:154 col:14
  ...
  %129 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !375 ; line:158 col:16
  call void @llvm.dbg.value(metadata float %.i085, i64 0, metadata !364, metadata !225), !dbg !363 ; var:"litColor" !DIExpression(DW_OP_bit_piece, 0, 32) func:"PS"
  call void @llvm.dbg.value(metadata float %.i186, i64 0, metadata !364, metadata !226), !dbg !363 ; var:"litColor" !DIExpression(DW_OP_bit_piece, 32, 32) func:"PS"
  call void @llvm.dbg.value(metadata float %.i287, i64 0, metadata !364, metadata !227), !dbg !363 ; var:"litColor" !DIExpression(DW_OP_bit_piece, 64, 32) func:"PS"
  ...
  %130 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !376 ; line:160 col:5
  ...
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 0, float %.i085), !dbg !376 ; line:160 col:5  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 1, float %.i186), !dbg !376 ; line:160 col:5  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 2, float %.i287), !dbg !376 ; line:160 col:5  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 3, float %.i3), !dbg !376 ; line:160 col:5  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  ret void, !dbg !376 ; line:160 col:5
}
...
!229 = !DILocation(line: 131, column: 23, scope: !17)
!230 = !DILocation(line: 131, column: 2, scope: !17)
!231 = !DILocation(line: 135, column: 19, scope: !17)
!232 = !DILocation(line: 135, column: 17, scope: !17)
!233 = !DILocation(line: 138, column: 21, scope: !17)
!234 = !DILocation(line: 138, column: 30, scope: !17)
!235 = !DILocation(line: 138, column: 12, scope: !17)
!236 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "toEyeW", scope: !17, file: !1, line: 138, type: !24)
!237 = !DILocation(line: 139, column: 23, scope: !17)
!238 = !DILocation(line: 139, column: 11, scope: !17)
!239 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "distToEye", scope: !17, file: !1, line: 139, type: !8)
!240 = !DIExpression()
!241 = !DILocation(line: 140, column: 12, scope: !17)
!242 = !DILocation(line: 142, column: 22, scope: !17)
!243 = !DILocation(line: 142, column: 36, scope: !17)
!244 = !DILocation(line: 142, column: 12, scope: !17)
!245 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "ambient", scope: !17, file: !1, line: 142, type: !4)
!246 = !DILocation(line: 143, column: 36, scope: !17)
!247 = !DILocation(line: 143, column: 34, scope: !17)
!248 = !DILocation(line: 143, column: 17, scope: !17)
!249 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "shininess", scope: !17, file: !1, line: 143, type: !99)
!250 = !DILocation(line: 144, column: 20, scope: !17)
!251 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "mat", scope: !17, file: !1, line: 144, type: !56)
!252 = !DILocation(line: 144, column: 14, scope: !17)
!253 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "mat", arg: 2, scope: !41, file: !42, line: 194, type: !56)
!254 = !DILocation(line: 194, column: 59, scope: !41, inlinedAt: !255)
!255 = distinct !DILocation(line: 147, column: 26, scope: !17)
...
!258 = distinct !DILocation(line: 128, column: 12, scope: !61, inlinedAt: !259)
!259 = distinct !DILocation(line: 202, column: 37, scope: !260, inlinedAt: !255)
!260 = distinct !DILexicalBlock(scope: !261, file: !42, line: 201, column: 5)
!261 = distinct !DILexicalBlock(scope: !262, file: !42, line: 200, column: 5)
!262 = distinct !DILexicalBlock(scope: !41, file: !42, line: 200, column: 5)
!263 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "mat", arg: 2, scope: !61, file: !42, line: 115, type: !56)
!264 = !DILocation(line: 115, column: 50, scope: !61, inlinedAt: !259)
!265 = !DILocation(line: 144, column: 37, scope: !17)
...
!269 = !DILocation(line: 145, column: 12, scope: !17)
!270 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "shadowFactor", scope: !17, file: !1, line: 145, type: !24)
!271 = !DILocation(line: 147, column: 26, scope: !17)
!272 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "toEye", arg: 5, scope: !41, file: !42, line: 194, type: !24)
!273 = !DILocation(line: 194, column: 98, scope: !41, inlinedAt: !255)
!274 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "normal", arg: 4, scope: !41, file: !42, line: 194, type: !24)
!275 = !DILocation(line: 194, column: 83, scope: !41, inlinedAt: !255)
!276 = !DILocation(line: 196, column: 12, scope: !41, inlinedAt: !255)
!277 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "result", scope: !41, file: !42, line: 196, type: !24)
!278 = !DILocation(line: 197, column: 9, scope: !41, inlinedAt: !255)
!279 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "i", scope: !41, file: !42, line: 197, type: !15)
!280 = !DILocation(line: 200, column: 11, scope: !262, inlinedAt: !255)
!281 = !DILocation(line: 200, column: 5, scope: !262, inlinedAt: !255)
!282 = !DILocation(line: 202, column: 19, scope: !260, inlinedAt: !255)
!283 = !DILocation(line: 202, column: 37, scope: !260, inlinedAt: !255)
!284 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "toEye", arg: 4, scope: !61, file: !42, line: 115, type: !24)
!285 = !DILocation(line: 115, column: 77, scope: !61, inlinedAt: !259)
!286 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "normal", arg: 3, scope: !61, file: !42, line: 115, type: !24)
!287 = !DILocation(line: 115, column: 62, scope: !61, inlinedAt: !259)
!288 = !DILocation(line: 118, column: 26, scope: !61, inlinedAt: !259)
!289 = !DILocation(line: 118, column: 23, scope: !61, inlinedAt: !259)
!290 = !DILocation(line: 118, column: 12, scope: !61, inlinedAt: !259)
!291 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "lightVec", scope: !61, file: !42, line: 118, type: !24)
!292 = !DILocation(line: 121, column: 23, scope: !61, inlinedAt: !259)
!293 = !DILocation(line: 121, column: 19, scope: !61, inlinedAt: !259)
!294 = !DILocation(line: 121, column: 11, scope: !61, inlinedAt: !259)
!295 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "ndotl", scope: !61, file: !42, line: 121, type: !8)
!296 = !DILocation(line: 127, column: 30, scope: !61, inlinedAt: !259)
!297 = !DILocation(line: 127, column: 39, scope: !61, inlinedAt: !259)
!298 = !DILocation(line: 127, column: 12, scope: !61, inlinedAt: !259)
!299 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "lightStrength", scope: !61, file: !42, line: 127, type: !24)
!300 = !DILocation(line: 128, column: 12, scope: !61, inlinedAt: !259)
...
!354 = !DILocation(line: 128, column: 5, scope: !61, inlinedAt: !259)
!355 = !DILocation(line: 202, column: 35, scope: !260, inlinedAt: !255)
!356 = !DILocation(line: 202, column: 16, scope: !260, inlinedAt: !255)
!357 = !DILocation(line: 200, column: 36, scope: !261, inlinedAt: !255)
!358 = !DILocation(line: 200, column: 18, scope: !261, inlinedAt: !255)
!359 = !DILocation(line: 220, column: 5, scope: !41, inlinedAt: !255)
!360 = !DILocation(line: 147, column: 12, scope: !17)
!361 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "directLight", scope: !17, file: !1, line: 147, type: !4)
!362 = !DILocation(line: 150, column: 31, scope: !17)
!363 = !DILocation(line: 150, column: 12, scope: !17)
!364 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "litColor", scope: !17, file: !1, line: 150, type: !4)
!365 = !DILocation(line: 153, column: 45, scope: !17)
!366 = !DILocation(line: 153, column: 43, scope: !17)
!367 = !DILocation(line: 153, column: 58, scope: !17)
!368 = !DILocation(line: 153, column: 56, scope: !17)
!369 = !DILocation(line: 153, column: 23, scope: !17)
!370 = !DILocation(line: 153, column: 11, scope: !17)
!371 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "fogAmount", scope: !17, file: !1, line: 153, type: !8)
!372 = !DILocation(line: 154, column: 31, scope: !17)
!373 = !DILocation(line: 154, column: 16, scope: !17)
!374 = !DILocation(line: 154, column: 14, scope: !17)
!375 = !DILocation(line: 158, column: 16, scope: !17)
!376 = !DILocation(line: 160, column: 5, scope: !17)
!377 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "shadowFactor", arg: 6, scope: !41, file: !42, line: 194, type: !24)
!378 = !DILocation(line: 194, column: 112, scope: !41, inlinedAt: !255)
