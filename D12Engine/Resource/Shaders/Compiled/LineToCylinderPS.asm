...
; <label>:43                                      ; preds = %42, %26
  ...
  %80 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !300 ; line:196 col:12
  ...
  %81 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !302 ; line:197 col:9
  call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !303, metadata !242), !dbg !302 ; var:"i" !DIExpression() func:"ComputeLighting"
  %82 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !304 ; line:200 col:11
  call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !303, metadata !242), !dbg !302 ; var:"i" !DIExpression() func:"ComputeLighting"
  br label %.lr.ph, !dbg !305 ; line:200 col:5

.lr.ph:                                           ; preds = %43
  br label %83, !dbg !305 ; line:200 col:5
...
; <label>:83                                      ; preds = %83, %.lr.ph
  ...
  %84 = getelementptr [3 x float], [3 x float]* %10, i32 0, i32 %i.i.0, !dbg !306 ; line:202 col:19
  %85 = load float, float* %84, !dbg !306 ; line:202 col:19
  %86 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !307 ; line:202 col:37
  %87 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !307 ; line:202 col:37
  %88 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !307 ; line:202 col:37
  ...
  %89 = mul i32 %i.i.0, 3, !dbg !312 ; line:118 col:26
  %90 = add i32 28, %89, !dbg !312 ; line:118 col:26
  %91 = add i32 %90, 1, !dbg !312 ; line:118 col:26
  %92 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPass_cbuffer, i32 %91), !dbg !312 ; line:118 col:26  ; CBufferLoadLegacy(handle,regIndex)
  %93 = extractvalue %dx.types.CBufRet.f32 %92, 0, !dbg !312 ; line:118 col:26
  %94 = extractvalue %dx.types.CBufRet.f32 %92, 1, !dbg !312 ; line:118 col:26
  %95 = extractvalue %dx.types.CBufRet.f32 %92, 2, !dbg !312 ; line:118 col:26
  %.i044 = fsub fast float -0.000000e+00, %93, !dbg !313 ; line:118 col:23
  %.i146 = fsub fast float -0.000000e+00, %94, !dbg !313 ; line:118 col:23
  %.i248 = fsub fast float -0.000000e+00, %95, !dbg !313 ; line:118 col:23
  %96 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !314 ; line:118 col:12
  ...
  %97 = call float @dx.op.dot3.f32(i32 55, float %.i044, float %.i146, float %.i248, float %.i027, float %.i128, float %.i229), !dbg !316 ; line:121 col:23  ; Dot3(ax,ay,az,bx,by,bz)
  %FMax5 = call float @dx.op.binary.f32(i32 35, float %97, float 0.000000e+00), !dbg !317 ; line:121 col:19  ; FMax(a,b)
  %98 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !318 ; line:121 col:11
  ...
  %99 = mul i32 %i.i.0, 3, !dbg !320 ; line:127 col:30
  %100 = add i32 28, %99, !dbg !320 ; line:127 col:30
  %101 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %cbPass_cbuffer, i32 %100), !dbg !320 ; line:127 col:30  ; CBufferLoadLegacy(handle,regIndex)
  %102 = extractvalue %dx.types.CBufRet.f32 %101, 0, !dbg !320 ; line:127 col:30
  %103 = extractvalue %dx.types.CBufRet.f32 %101, 1, !dbg !320 ; line:127 col:30
  %104 = extractvalue %dx.types.CBufRet.f32 %101, 2, !dbg !320 ; line:127 col:30
  %.i049 = fmul fast float %102, %FMax5, !dbg !321 ; line:127 col:39
  %.i150 = fmul fast float %103, %FMax5, !dbg !321 ; line:127 col:39
  %.i251 = fmul fast float %104, %FMax5, !dbg !321 ; line:127 col:39
  %105 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !322 ; line:127 col:12
  call void @llvm.dbg.value(metadata float %.i049, i64 0, metadata !323, metadata !235), !dbg !322 ; var:"lightStrength" !DIExpression(DW_OP_bit_piece, 0, 32) func:"ComputeDirectionalLight"
  call void @llvm.dbg.value(metadata float %.i150, i64 0, metadata !323, metadata !236), !dbg !322 ; var:"lightStrength" !DIExpression(DW_OP_bit_piece, 32, 32) func:"ComputeDirectionalLight"
  call void @llvm.dbg.value(metadata float %.i251, i64 0, metadata !323, metadata !237), !dbg !322 ; var:"lightStrength" !DIExpression(DW_OP_bit_piece, 64, 32) func:"ComputeDirectionalLight"
  %106 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !324 ; line:128 col:12
  %107 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !324 ; line:128 col:12
  ...
  %130 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !378 ; line:128 col:5
  %.i088 = fmul fast float %85, %.i085, !dbg !379 ; line:202 col:35
  %.i189 = fmul fast float %85, %.i186, !dbg !379 ; line:202 col:35
  %.i290 = fmul fast float %85, %.i287, !dbg !379 ; line:202 col:35
  %.i040 = fadd fast float %result.i.0.i0, %.i088, !dbg !380 ; line:202 col:16
  %.i141 = fadd fast float %result.i.0.i1, %.i189, !dbg !380 ; line:202 col:16
  %.i242 = fadd fast float %result.i.0.i2, %.i290, !dbg !380 ; line:202 col:16
  %131 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !380 ; line:202 col:16
  ...
  %132 = add nsw i32 %i.i.0, 1, !dbg !381 ; line:200 col:36
  %133 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !381 ; line:200 col:36
  ...
  %134 = icmp slt i32 %132, 3, !dbg !382 ; line:200 col:18
  br i1 %134, label %83, label %".\01?ComputeLighting@@YA?AV?$vector@M$03@@Y0BA@ULight@@UMaterial@@V?$vector@M$02@@222@Z.exit_crit_edge", !dbg !305 ; line:200 col:5

".\01?ComputeLighting@@YA?AV?$vector@M$03@@Y0BA@ULight@@UMaterial@@V?$vector@M$02@@222@Z.exit_crit_edge": ; preds = %83
  br label %"\01?ComputeLighting@@YA?AV?$vector@M$03@@Y0BA@ULight@@UMaterial@@V?$vector@M$02@@222@Z.exit", !dbg !305 ; line:200 col:5
...
"\01?ComputeLighting@@YA?AV?$vector@M$03@@Y0BA@ULight@@UMaterial@@V?$vector@M$02@@222@Z.exit": ; preds = %".\01?ComputeLighting@@YA?AV?$vector@M$03@@Y0BA@ULight@@UMaterial@@V?$vector@M$02@@222@Z.exit_crit_edge"
  ...
  call void @llvm.dbg.value(metadata float %.i141, i64 0, metadata !301, metadata !236), !dbg !300 ; var:"result" !DIExpression(DW_OP_bit_piece, 32, 32) func:"ComputeLighting"
  call void @llvm.dbg.value(metadata float %.i242, i64 0, metadata !301, metadata !237), !dbg !300 ; var:"result" !DIExpression(DW_OP_bit_piece, 64, 32) func:"ComputeLighting"
  %135 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @dx.nothing.a, i32 0, i32 0), !dbg !383 ; line:220 col:5
...
!45 = !DISubprogram(name: "ComputeLighting", linkageName: "\01?ComputeLighting@@YA?AV?$vector@M$03@@Y0BA@ULight@@UMaterial@@V?$vector@M$02@@222@Z", scope: !46, file: !46, line: 194, type: !47, isLocal: false, isDefinition: true, scopeLine: 195, flags: DIFlagPrototyped, isOptimized: false)
!46 = !DIFile(filename: "C:\5CUsers\5Ccjw78\5CDesktop\5CD12Engine\5CD12Engine\5CResource\5CShaders/LightingUtil.hlsli", directory: "")
...
!65 = !DISubprogram(name: "ComputeDirectionalLight", linkageName: "\01?ComputeDirectionalLight@@YA?AV?$vector@M$02@@ULight@@UMaterial@@V1@2@Z", scope: !46, file: !46, line: 115, type: !66, isLocal: false, isDefinition: true, scopeLine: 116, flags: DIFlagPrototyped, isOptimized: false)
...
!241 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "shadowFactor", arg: 6, scope: !45, file: !46, line: 194, type: !4)
!242 = !DIExpression()
!243 = !DILocation(line: 194, column: 112, scope: !45, inlinedAt: !244)
...
!278 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "mat", arg: 2, scope: !45, file: !46, line: 194, type: !60)
!279 = !DILocation(line: 194, column: 59, scope: !45, inlinedAt: !244)
!280 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "mat", arg: 2, scope: !65, file: !46, line: 115, type: !60)
!281 = !DILocation(line: 115, column: 50, scope: !65, inlinedAt: !282)
!282 = distinct !DILocation(line: 202, column: 37, scope: !283, inlinedAt: !244)
!283 = distinct !DILexicalBlock(scope: !284, file: !46, line: 201, column: 5)
!284 = distinct !DILexicalBlock(scope: !285, file: !46, line: 200, column: 5)
!285 = distinct !DILexicalBlock(scope: !45, file: !46, line: 200, column: 5)
...
!288 = distinct !DILocation(line: 128, column: 12, scope: !65, inlinedAt: !282)
...
!296 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "toEye", arg: 5, scope: !45, file: !46, line: 194, type: !4)
!297 = !DILocation(line: 194, column: 98, scope: !45, inlinedAt: !244)
!298 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "normal", arg: 4, scope: !45, file: !46, line: 194, type: !4)
!299 = !DILocation(line: 194, column: 83, scope: !45, inlinedAt: !244)
!300 = !DILocation(line: 196, column: 12, scope: !45, inlinedAt: !244)
!301 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "result", scope: !45, file: !46, line: 196, type: !4)
!302 = !DILocation(line: 197, column: 9, scope: !45, inlinedAt: !244)
!303 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "i", scope: !45, file: !46, line: 197, type: !14)
!304 = !DILocation(line: 200, column: 11, scope: !285, inlinedAt: !244)
!305 = !DILocation(line: 200, column: 5, scope: !285, inlinedAt: !244)
!306 = !DILocation(line: 202, column: 19, scope: !283, inlinedAt: !244)
!307 = !DILocation(line: 202, column: 37, scope: !283, inlinedAt: !244)
!308 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "toEye", arg: 4, scope: !65, file: !46, line: 115, type: !4)
!309 = !DILocation(line: 115, column: 77, scope: !65, inlinedAt: !282)
!310 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "normal", arg: 3, scope: !65, file: !46, line: 115, type: !4)
!311 = !DILocation(line: 115, column: 62, scope: !65, inlinedAt: !282)
!312 = !DILocation(line: 118, column: 26, scope: !65, inlinedAt: !282)
!313 = !DILocation(line: 118, column: 23, scope: !65, inlinedAt: !282)
!314 = !DILocation(line: 118, column: 12, scope: !65, inlinedAt: !282)
!315 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "lightVec", scope: !65, file: !46, line: 118, type: !4)
!316 = !DILocation(line: 121, column: 23, scope: !65, inlinedAt: !282)
!317 = !DILocation(line: 121, column: 19, scope: !65, inlinedAt: !282)
!318 = !DILocation(line: 121, column: 11, scope: !65, inlinedAt: !282)
!319 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "ndotl", scope: !65, file: !46, line: 121, type: !8)
!320 = !DILocation(line: 127, column: 30, scope: !65, inlinedAt: !282)
!321 = !DILocation(line: 127, column: 39, scope: !65, inlinedAt: !282)
!322 = !DILocation(line: 127, column: 12, scope: !65, inlinedAt: !282)
!323 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "lightStrength", scope: !65, file: !46, line: 127, type: !4)
!324 = !DILocation(line: 128, column: 12, scope: !65, inlinedAt: !282)
...
!378 = !DILocation(line: 128, column: 5, scope: !65, inlinedAt: !282)
!379 = !DILocation(line: 202, column: 35, scope: !283, inlinedAt: !244)
!380 = !DILocation(line: 202, column: 16, scope: !283, inlinedAt: !244)
!381 = !DILocation(line: 200, column: 36, scope: !284, inlinedAt: !244)
!382 = !DILocation(line: 200, column: 18, scope: !284, inlinedAt: !244)
!383 = !DILocation(line: 220, column: 5, scope: !45, inlinedAt: !244)
